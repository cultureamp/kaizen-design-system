...
Be sure to read the <LinkTo pageId="components-kaizenprovider-installation">KaizenProvider</LinkTo> documentation in case your app requires any further config, but generally this should be it!
