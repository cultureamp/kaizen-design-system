...
_Note that this step is required as long as you use any Kaizen component that contains an Icon._

Our <LinkTo pageId="components-icon-api-specification">Icons</LinkTo> (introduced in `@kaizen/components@1.67.0`) are sourced from [Google Material Symbols](https://fonts.google.com/icons).
