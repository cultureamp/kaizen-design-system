...
Overall version 2 **does not change** any existing Tailwind Preset API, however it now has a pre-requisite on an external resource for the features to work.
...
```
yarn add -D @kaizen/tailwind@2.0.0
```
