...
Custom SVG icons that extend the icon set for use cases not covered by Material Symbols. Use these when a specific icon is required that does not exist in the Material Symbols library.
