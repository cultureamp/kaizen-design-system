 ...
 */
export const SplitButton = ({ actionButtonProps, dropdownButtonProps, dropdownContent, isDropdownInitOpen, disabled, isReversed, dir, classNameOverride, ...restProps }: SplitButtonProps): JSX.Element => (<div dir={dir} className={classnames(styles.splitButton, classNameOverride)} {...restProps}>
    <ActionButton disabled={disabled} isReversed={isReversed} {...actionButtonProps}/>
    <Menu align={dir === "rtl" ? "left" : "right"} dropdownWidth="contain" button={<DropdownButton disabled={disabled} isReversed={isReversed} {...dropdownButtonProps}/>} menuVisible={isDropdownInitOpen}>
      {dropdownContent}
    </Menu>
  </div>);
