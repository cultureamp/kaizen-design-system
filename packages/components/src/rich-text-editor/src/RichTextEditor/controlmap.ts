...
import decreaseIndentIcon from "@icons/decrease-indent.icon.svg"
import increaseIndentIcon from "@icons/increase-indent.icon.svg"
import italicIcon from "@icons/italics.icon.svg"
import numberedListIcon from "@icons/numbered-list.icon.svg"
