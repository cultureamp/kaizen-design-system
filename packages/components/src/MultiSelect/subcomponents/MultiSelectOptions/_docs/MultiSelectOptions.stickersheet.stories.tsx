...
const StickerSheetTemplate: StickerSheetStory = {
    render: () => (<StickerSheet>
      ...
      <StickerSheet.Body>
        <StickerSheet.Row>
          <MultiSelectOptions id="id--multi-select-options--default" options={options} selectedValues={new Set()} onChange={() => undefined}/>
          <MultiSelectOptions id="id--multi-select-options--pseudo" options={options} selectedValues={new Set(["pancakes"])} onChange={() => undefined}/>
          <StickerSheet.Cell className="align-top">
            <MultiSelectOptions id="id--multi-select-options--empty-state" options={[]} selectedValues={new Set()} onChange={() => undefined}/>
          </StickerSheet.Cell>
        </StickerSheet.Row>
      </StickerSheet.Body>
    </StickerSheet>),
