...
const meta = {
    ...
    decorators: [
        Story => (<div className="overflow-scroll max-w-[200px] max-h-[200px] border-solid">
        <div id="testing-ground" className="relative flex justify-center items-center h-[500px] w-[500px]">
          <Story />
        </div>
      </div>),
    ],
...
const PopoverTemplate: Story = {
    render: args => {
        ...
        {isOpen && (<Popover {...args} portalContainer={document.getElementById("testing-ground") ?? undefined} refs={refs} focusOnProps={{
