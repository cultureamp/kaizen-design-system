...
const MultiSelectOptionFieldTemplate: Story = {
    render: args => {
        const [checkedStatus, setCheckedStatus] = useState<CheckboxProps["checkedStatus"]>(args.checkedStatus);
        ...
        return (<MultiSelectOptionField {...args} checkedStatus={checkedStatus} onChange={handleChange}/>);
    },
};
