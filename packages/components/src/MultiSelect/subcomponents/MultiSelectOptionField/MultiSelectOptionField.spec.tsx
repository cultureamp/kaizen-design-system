...
const MultiSelectOptionFieldWrapper = (customProps?: Partial<MultiSelectOptionFieldProps>): JSX.Element => {
    ...
    return (<MultiSelectOptionField id="id--jaffle" option={{ label: "Jaffle", value: "jaffle" }} checkedStatus={checkedStatus} onChange={e => {
            handleChange();
            onChange(e);
        }} {...customProps}/>);
};
