...
} & (ReadOnly | Controlled) & OverrideClassName<
...
export const Checkbox = ({ checkedStatus, classNameOverride, ...restProps }: CheckboxProps): JSX.Element => {
    ...
    return (<span className={classnames(styles.checkbox, checkedStatus !== "unchecked" && styles.selected, classNameOverride)}>
