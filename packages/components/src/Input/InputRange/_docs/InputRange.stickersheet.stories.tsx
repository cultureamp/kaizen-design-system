    ...
    render: () => (<StickerSheet>
      ...
      <StickerSheet.Body>
        <StickerSheet.Row>
          ...
          <InputRange id="inputRangeDisable" minLabel={<span data-sb-a11y-color-contrast-disable>Min</span>} maxLabel={<span data-sb-a11y-color-contrast-disable>Max</span>} value={2} disabled data-sb-a11y-color-contrast-disable/>
        </StickerSheet.Row>
      </StickerSheet.Body>
    </StickerSheet>),
};
