...
export const Input = ({ inputRef, status = "default", startIconAdornment, endIconAdornment, reversed = false, type = "text", value, defaultValue, classNameOverride, disabled, ...restProps }: InputProps): JSX.Element => (<div className={classnames(styles.wrapper, reversed && styles.withReversed, disabled && styles.withDisabled, startIconAdornment && styles.withStartIconAdornment, endIconAdornment && styles.withEndIconAdornment, status != "default" && styles.hasStatus)}>
    {startIconAdornment && (<div className={styles.startIconAdornment}>{startIconAdornment}</div>)}

    <input ref={inputRef} type={type} value={value} defaultValue={defaultValue} disabled={disabled} className={classnames(styles.input, styles[status], classNameOverride, reversed ? styles.reversed : styles.default, disabled && styles.disabled)} {...restProps}/>
