...
const EmptyStateWrapper: StoryFn<typeof EmptyState> = ({ isAnimated, ...args }) => <EmptyState isAnimated={IS_CHROMATIC ? false : isAnimated} {...args}/>;
const ButtonWrapper = (<div className={styles.buttonContainer}>
...
const CUSTOM_HEADING_PROPS: EmptyStateProps = {
    children: ButtonWrapper,
    bodyText: "Customise heading level so that the correct semantic heading level can be used for your page.",
    illustrationType: "neutral",
    headingProps: {
        variant: "heading-3",
