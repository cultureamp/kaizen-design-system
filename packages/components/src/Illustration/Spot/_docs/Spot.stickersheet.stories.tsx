...
const IllustrationExampleTile = ({ Component, name, }: {
    ...
    name: string;
}): JSX.Element => (<div className="w-[150px] inline-flex flex-col p-32 items-center">
    <Component />
    <Text variant="small">{name}</Text>
  </div>);
const StickerSheetTemplate: StickerSheetStory = {
    render: () => (<div className="grid gap-24">
      <div>
        <Heading variant="heading-3">Engagement</Heading>
        <div className="flex flex-wrap ">
          {engagementSpots.map((props, i) => (<IllustrationExampleTile key={`engagement-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {experienceSpots.map((props, i) => (<IllustrationExampleTile key={`experience-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {performanceSpots.map((props, i) => (<IllustrationExampleTile key={`performance-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {covidSpots.map((props, i) => (<IllustrationExampleTile key={`covid-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {newAccountSpots.map((props, i) => (<IllustrationExampleTile key={`new-account-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {moodSpots.map((props, i) => (<IllustrationExampleTile key={`moods-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {managerLearningSpots.map((props, i) => (<IllustrationExampleTile key={`skills-coach-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {officeSpots.map((props, i) => (<IllustrationExampleTile key={`offices-${i}`} {...props}/>))}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap ">
          {miscellaneousSpots.map((props, i) => (<IllustrationExampleTile key={`misc-${i}`} {...props}/>))}
        </div>
      </div>
    </div>),
};
