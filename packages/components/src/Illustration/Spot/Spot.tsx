...
const createSpotIllustration = (fileName: string) => 
// eslint-disable-next-line react/display-name
({ enableAspectRatio, ...restProps }: SpotProps): JSX.Element => (<Base aspectRatio={enableAspectRatio ? "square" : undefined} {...restProps} name={`${SPOT_ILLUSTRATION_BASE_PATH}${fileName}`}/>);
/**
