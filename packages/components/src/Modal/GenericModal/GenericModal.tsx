...
export type GenericModalProps = {
  ...
  onOutsideModalClick?: (event: MouseEvent | TouchEvent) => void
  ...
  return createPortal(
    ...
    >
      <FocusOn
        ...
        returnFocus={true}
        onEscapeKey={onEscapeKeyup ? onEscapeKeyHandler : undefined}
      ...
      >
         ...
         */}
        {}
        <div className={styles.scrollLayer} ref={scrollLayerRef} data-testid={`${id}-scrollLayer`}>
