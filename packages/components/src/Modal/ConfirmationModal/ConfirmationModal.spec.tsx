...
const ConfirmationModalWrapper = ({ children, ...props }: Partial<ConfirmationModalProps>): JSX.Element => (<ConfirmationModal mood="informative" isOpen={true} title="Example Modal Title" onDismiss={(): void => undefined} onConfirm={(): void => undefined} {...props}>
    {children}
  </ConfirmationModal>);
describe("<ConfirmationModal />", () => {
    ...
    it("supports a dismiss action when dismiss button is pressed", async () => {
        ...
        const { getByLabelText } = render(<ConfirmationModalWrapper onConfirm={handleConfirm} onDismiss={handleDismiss}>
        Example modal body
    ...
    it("supports a dismiss action when cancel button is pressed", async () => {
        const handleConfirm = jest.fn();
        const handleDismiss = jest.fn();
        const { getByText } = render(<ConfirmationModalWrapper onDismiss={handleDismiss} onConfirm={handleConfirm}>
        Example modal body
      </ConfirmationModalWrapper>);
