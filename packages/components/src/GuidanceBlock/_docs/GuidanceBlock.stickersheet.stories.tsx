...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => (<StickerSheet isReversed={isReversed}>
      <StickerSheet.Body>
        <>
          {variantsMap.map(variant => (<StickerSheet.Row key={variant} rowTitle={variant}>
        ...
        <StickerSheet.Row rowTitle="Tooltip">
          <GuidanceBlock {...TEXT_PROPS} actions={{
            primary: {
        ...
        <StickerSheet.Row rowTitle="Scene Illustration">
          <GuidanceBlock {...TEXT_PROPS} illustration={<EmptyStatesPositive alt=""/>} illustrationType="scene"/>
        </StickerSheet.Row>
