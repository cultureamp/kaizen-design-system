...
### Inline
Changes the FieldGroup to an inline element with no bottom margin. This can be seen in the `Slider`<LinkTo pageId="forms-slider">component</LinkTo>. You can see inline vs block scope in the following stories:
