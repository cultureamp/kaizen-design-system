...
### Inline
Changes the FieldGroup to an inline element with no bottom margin. This can be seen in the `Slider` [component](/?path=/docs/components-slider--docs). You can see inline vs block scope in the following stories:
