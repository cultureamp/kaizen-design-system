 ...
 */
export const Badge = ({ children, variant = "default", reversed = false, size = "small", classNameOverride, ...restProps }: BadgeProps): JSX.Element => (<span className={classnames(styles.badge, styles[variant], classNameOverride, reversed && styles.reversed, size === "large" && styles.large)} {...restProps}>
...
export const BadgeAnimated = (props: BadgeProps): JSX.Element => {
    ...
    return (<span className={classnames(styles.animation, isFocused && styles.animationOn)}>
      <Badge {...props}/>
    </span>);
};
