 ...
 */
export const PaginationLink = ({ pageNumber, reversed = false, isActive = false, ...restProps }: PaginationLinkProps): JSX.Element => (<GenericButton {...restProps} paginationLink reversed={reversed} isActive={isActive} label={`${pageNumber}`}/>);
