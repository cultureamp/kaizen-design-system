...
import { ArrowBackwardIcon, ArrowForwardIcon, EndIcon, StartIcon, } from "~components/Icon";
 ...
 */
export const DirectionalLink = ({ reversed = false, disabled = false, ...otherProps }: DirectionalLinkProps): JSX.Element => (<GenericButton reversed={reversed} disabled={disabled} {...otherProps} iconButton directionalLink icon={iconMap[otherProps.direction]}/>);
