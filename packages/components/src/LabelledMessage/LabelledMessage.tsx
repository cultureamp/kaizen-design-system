...
export const LabelledMessage = ({ label, message, classNameOverride, ...restProps }: LabelledMessageProps): JSX.Element => (<span className={classnames(styles.labelledMessage, classNameOverride)} {...restProps}>
    <span>{label}</span>
