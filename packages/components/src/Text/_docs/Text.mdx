...
If you are just bolding for style, use Tailwind with `classNameOverride` instead. E.g. `<Text variant="body" classNameOverride="kz-font-weight-paragraph-bold">The quick brown fox jumps over the lazy dog.</Text>`
