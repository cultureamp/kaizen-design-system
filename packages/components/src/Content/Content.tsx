 ...
 */
export const Content = React.forwardRef<HTMLDivElement, ContentProps>(({ children, style, classNameOverride, ...restProps }, ref) => (<div ref={ref} className={classnames(styles.content, classNameOverride)} style={style} {...restProps}>
      {children}
    </div>));
