 ...
 */
export const Card = ({ children, tag = "div", variant = "default", isElevated = false, classNameOverride, ...props }: CardProps): JSX.Element => {
    const Tag = tag;
    return (<Tag className={classnames(styles.wrapper, styles[variant], classNameOverride, isElevated && styles.elevated)} {...props}>
      {children}
    </Tag>);
};
