...
Usually part of compositions such as <LinkTo pageId="forms-textarea-textareafield">TextAreaField</LinkTo>.
...
You can use our <LinkTo pageId="forms-label">Label</LinkTo> component
