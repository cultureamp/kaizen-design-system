...
This can be achieved a couple ways:

#### aria-label
For when no visible text is available to link to your Text Area
```
<TextArea aria-label="This is my Label" />
```

#### aria-labelledby
For linking text that isn't in a `Label`
