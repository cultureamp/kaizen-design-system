...
## API
The `Button` component is built on top of the [React Aria Button API](https://react-spectrum.adobe.com/react-aria/Button.html#props). While this exposes majority of the functionality the core properties for the `Button` can be seen in the following table.
