...
const ExampleToolbar = (): JSX.Element => (<Toolbar aria-label="Toolbar" aria-controls="editable-id">
    <ToolbarSection>
      <ToggleIconButton label="Bold" icon={<BoldIcon role="presentation"/>}/>
      <ToggleIconButton label="Italic" icon={<BoldIcon role="presentation"/>}/>
      <ToggleIconButton label="Underline" icon={<BoldIcon role="presentation"/>}/>
    </ToolbarSection>
  </Toolbar>);
