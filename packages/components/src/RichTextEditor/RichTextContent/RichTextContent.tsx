...
export const RichTextContent = (props: RichTextContentProps): JSX.Element => {
    ...
    const [editorRef] = useRichTextEditor(ProseMirrorState.EditorState.create({
    ...
    return (<div ref={editorRef} className={classnames(styles.content, classNameOverride)} {...restProps}/>);
};
