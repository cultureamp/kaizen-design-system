...
export const LinkEditor = ({ attrs, removeMark, updateAttrs, selectionPosition, focusEditor, }: LinkEditorProps): JSX.Element => {
    ...
    return (<>
      {isPopoverOpen && (<LinkPopover href={href} selectionPosition={selectionPosition} onRemove={() => {
                removeMark();
                focusEditor();
            }} onEdit={() => {
      ...
      <LinkModal defaultHref={href} isOpen={modalOpen} onAfterLeave={focusEditor} onSubmit={(submittedHref: string) => {
