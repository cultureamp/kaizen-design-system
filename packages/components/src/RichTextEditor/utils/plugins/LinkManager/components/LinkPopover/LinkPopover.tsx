...
export const LinkPopover = ({ href, onRemove, onEdit, selectionPosition, }: LinkPopoverProps): JSX.Element => {
        ...
        <div className={styles.popoverContent}>
          ...
          <div className={styles.popoverLinkContainer}>
            <Text variant="body" tag="div" classNameOverride={styles.paragraphFlex}>
              <a className={styles.popoverLink} href={href != null ? href : undefined} target="_blank" rel="noopener noreferrer">
                {href}
              </a>
            </Text>
          </div>
          ...
          <RemoveLinkIcon role="img" onClick={onRemove} aria-label="Remove link"/>
        </div>
      </Popover>
    </>);
};
