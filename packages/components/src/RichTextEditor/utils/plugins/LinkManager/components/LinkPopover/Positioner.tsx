...
export const Positioner = forwardRef<HTMLElement, SelectionPosition>(({ top, left, height, width }, ref) => {
    ...
    if (windowScroll === undefined || portalContainer === undefined)
        return null;
    const [x, y] = windowScroll;
    return createPortal(<div ref={ref as React.Ref<HTMLDivElement>} style={{
            height: `${height}px`,
            left: `${left + x}px`,
            pointerEvents: "none",
            position: "absolute",
