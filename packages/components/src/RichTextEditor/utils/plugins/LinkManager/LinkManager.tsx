...
import { AttrsValidator, getMarkAttrs, getMarkRange, markContainsSelection, markIsActive, removeMark, updateMark, validateAndRemoveMarks, } from "../../commands";
...
class LinkManager {
    ...
    onResize: () => void;
    constructor(view: CAEditorView, markType: MarkType, editorComponent: ComponentType<LinkEditorProps>, linkAttributeValidator: AttrsValidator) {
...
export const createLinkManager = ({ markType, editorComponent = LinkEditor, linkAttributeValidator = defaultLinkAttributeValidator, }: CreateLinkManagerArgs): Plugin => new Plugin({
    view(editorView) {
