...
const Wrapper = ({ emitter, componentProps, Component, }: {
    emitter: Nanobus;
 ...
 */
export const createReactTooltipWrapper = (parentNode: HTMLElement, Component: ElementType, componentProps: LinkEditorProps): {
    destroy: () => void;
