...
const Scenario = ({ onChange = () => undefined, editable = true, }: {
    ...
    const [ref, editorState, dispatchTransaction, setEditableStatus] = useRichTextEditor(testEditorState, { "aria-labelledby": "label-ref-id", "data-testid": "12345678" }, { editable });
    useEffect(() => {
