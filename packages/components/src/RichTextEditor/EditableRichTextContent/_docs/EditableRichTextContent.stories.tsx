...
const EditableRichTextContentTemplate: Story = {
    render: props => {
        ...
        const handleOnChange: RichTextEditorProps["onChange"] = editorState => setEditRTEData(editorState.toJSON().doc.content);
        ...
        if (editMode) {
            return (<>
          <RichTextEditor labelText={props.labelText} controls={[
                ...
                ]} defaultValue={editRteData} onChange={handleOnChange}/>
        ...
        return (<EditableRichTextContent onClick={handleContentClick} content={readRteData} labelText={props.labelText}/>);
    },
    args: {
