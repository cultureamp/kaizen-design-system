    ...
    render: ({ isReversed }) => (<StickerSheet isReversed={isReversed}>
      ...
      <StickerSheet.Body>
        <StickerSheet.Row rowTitle="Default">
          ...
          <>
            <RadioGroup labelText="Radio group label" reversed={isReversed}>
              <RadioField labelText="Label" name="radio" value="radio-1" disabled reversed={isReversed}/>
              <RadioField labelText="Label" name="radio" value="radio-2" disabled reversed={isReversed}/>
              <RadioField labelText="Label" name="radio" value="radio-3" disabled reversed={isReversed}/>
            </RadioGroup>
            <Text variant="body" color={isReversed ? "white" : "dark"}>
              Next line
            </Text>
