...
export const Radio = ({ name, value, selectedStatus = false, reversed = false, onChange, classNameOverride, ...restProps }: RadioProps): JSX.Element => (
// @todo: Move classNameOverride to span
<span>
    <input type="radio" name={name} value={value} checked={selectedStatus} className={classnames(styles.radioInput, classNameOverride, reversed && styles.reversed)} onChange={onChange} readOnly={onChange === undefined} {...restProps}/>
