...
const DateInputWithIconButtonWrapper = (props: Partial<DateInputWithIconButtonProps>): JSX.Element => <DateInputWithIconButton {...defaultProps} {...props}/>;
describe("<DateInputWithIconButton />", () => {
    describe("Icon button", () => {
        ...
        it("has helpful label showing the current date when one is selected", () => {
            render(<DateInputWithIconButtonWrapper value="Mar 1, 2022" onChange={(): void => undefined}/>);
    ...
    describe("Refs", () => {
        it("correctly passes through input and button refs", async () => {
            ...
            const Wrapper = (): JSX.Element => {
                ...
                return (<>
            <DateInputWithIconButton ref={ref} id="test__date-input-field--ref" labelText="label" onButtonClick={jest.fn<void, [
                    ]>()}/>
