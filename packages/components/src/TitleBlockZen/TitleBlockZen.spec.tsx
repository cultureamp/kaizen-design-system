...
describe("<TitleBlockZen />", () => {
    ...
    describe("when the primary action is a button with only an href", () => {
        ...
        it("renders the primary action button label and href", () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" primaryAction={primaryActionAsLink}>
          Example
        </TitleBlockZen>);
    ...
    describe("when the primary action is a button with only an onClick", () => {
        ...
        it("renders the primary action button label and onClick", async () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" primaryAction={primaryActionAsButton}>
          Example
        </TitleBlockZen>);
            const btn = getByTestId("title-block-primary-action-button");
    ...
    describe("when the primary action is a button with both an href and an onClick", () => {
        ...
        it("renders the primary action button label, href and onClick", async () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" primaryAction={primaryActionAsLinkAndOnClick}>
          Example
        </TitleBlockZen>);
            const btn = getByTestId("title-block-primary-action-button");
    ...
    describe("when the primary action is a menu", () => {
        ...
        it("renders the primary action menu button with label and menu items", async () => {
            const { getByTestId, getAllByTestId } = render(<TitleBlockZen title="Test Title" primaryAction={primaryActionAsMenu}>
          Example
        </TitleBlockZen>);
            const btn = getByTestId("title-block-primary-action-button");
        ...
        it("passes the primary menu items to the mobile actions drawer", () => {
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" primaryAction={primaryActionAsMenu}>
          Example
        </TitleBlockZen>);
    ...
    describe("when the default action is a button with only an href", () => {
        ...
        it("renders the default action button label and href", () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" defaultAction={defaultActionAsLink}>
          Example
        </TitleBlockZen>);
    ...
    describe("when the default action is a button with only an onClick", () => {
        ...
        it("renders the default action button label and onClick", async () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" defaultAction={defaultActionAsButton}>
          Example
        </TitleBlockZen>);
            const btn = getByTestId("title-block-default-action-button");
    ...
    describe("when the default action is a button with both an href and an onClick", () => {
        ...
        it("renders the default action button label, href and onClick", async () => {
            const { getByTestId } = render(<TitleBlockZen title="Test Title" defaultAction={defaultActionAsLinkAndOnClick}>
          Example
        </TitleBlockZen>);
            const btn = getByTestId("title-block-default-action-button");
        ...
        it("creates a single mobile actions default link menu item with both href and onClick", async () => {
            const { getByTestId, queryByTestId } = render(<TitleBlockZen title="Test Title" defaultAction={defaultActionAsLinkAndOnClick}>
          Example
        </TitleBlockZen>);
            const menuItem = getByTestId("title-block-mobile-actions-default-link");
    ...
    describe("when a secondary action is passed with both an href and an onClick", () => {
        ...
        it("renders the secondary action with both the href and onClick", async () => {
            ...
            const { getByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[secondaryActionWithLinkAndOnClick]}>
          Example
        </TitleBlockZen>);
        ...
        it("renders the action as a single mobile actions drawer item with an onClick", async () => {
            ...
            const spy = jest
                .spyOn(global.console, "warn")
                .mockImplementation(mockWarnFn);
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[secondaryActionWithLinkAndOnClick]}>
          Example
        </TitleBlockZen>);
    ...
    describe("when a custom compent is provided for section title", () => {
        it("renders a custom element in section title", async () => {
            ...
            const CustomComponent = (props: SectionTitleRenderProps): JSX.Element => (<button type="button">{props.sectionTitle}</button>);
            render(<TitleBlockZen title="Test title" sectionTitle={expectedText} renderSectionTitle={CustomComponent}/>);
    ...
    describe("when a secondary action is passed with only an href", () => {
        ...
        it("renders the action as a single mobile actions drawer item with the correct href", () => {
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[secondaryActionWithLink]}>
          Example
        </TitleBlockZen>);
            const btn = getAllByTestId("title-block-mobile-actions-secondary-action");
            expect(btn.length).toEqual(1);
    ...
    describe("when autoHideMobileActionsMenu is true", () => {
        ...
        it("hides the other actions menu when user clicks a menu item", async () => {
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[secondaryActionWithLink]} autoHideMobileActionsMenu>
          Example
        </TitleBlockZen>);
    ...
    describe("when a disabled secondary action is passed with only an onClick", () => {
        ...
        it("renders the action as a single disabled mobile actions drawer item with no onClick", async () => {
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[secondaryActionWithOnClick]}>
          Example
        </TitleBlockZen>);
            const btn = getAllByTestId("title-block-mobile-actions-secondary-action");
            expect(btn.length).toEqual(1);
    ...
    describe("when a disabled secondary overflow menu item is passed with only an onClick for the action", () => {
        ...
        it("renders the action as a single disabled mobile actions drawer item with no onClick", async () => {
            const { getAllByTestId } = render(<TitleBlockZen title="Test Title" secondaryActions={[]} secondaryOverflowMenuItems={[secondaryOverflowMenuItemWithOnClick]}>
          Example
        </TitleBlockZen>);
    ...
    describe("survey status", () => {
        it("doesn't render tag when field is omitted", async () => {
            ...
            await waitFor(() => {
                expect(screen.queryByTestId("survey-status-tag")).not.toBeInTheDocument();
            });
        });
        it.each([
            ["draft", "statusDraft"],
            ...
            ["default", "default"],
        ])("renders tag with correct text and variant when %s status", async (status, expectedClassName) => {
            render(<TitleBlockZen title="Test Title" surveyStatus={{
                    text: `${status} text`,
                    status: `${status}` as "draft" | "live" | "scheduled" | "closed" | "sentimentPositive" | "default",
                }}>
            Example
          </TitleBlockZen>);
    ...
    describe("automation ID behaviour", () => {
        describe("when default automation IDs are not provided alongside required conditional renders", () => {
            it("renders the default automation IDs", () => {
                ...
                const { container } = render(<TitleBlockZen title="Test Title" subtitle="Test Subtitle" avatar={<div>Test JSX Avatar Component</div>} breadcrumb={{
                        text: "Test Breadcrumb",
                        path: "/",
                        handleClick: jest.fn(),
                    }} sectionTitle="Test Section Title" sectionTitleDescription="Test Section Title Description">
            Example
          </TitleBlockZen>);
        ...
        describe("when default automation IDs are provided alongside required conditional renders", () => {
            it("renders the provided automation IDs", () => {
                ...
                const { container } = render(<TitleBlockZen title="Test Title" subtitle="Test Subtitle" avatar={<div>Test JSX Avatar Component</div>} breadcrumb={{
                        ...
                        path: "/",
                        handleClick: jest.fn(),
                    }} sectionTitle="Test Section Title" sectionTitleDescription="Test Section Title Description" titleAutomationId={automationdIds.titleAutomationId} avatarAutomationId={automationdIds.avatarAutomationId} subtitleAutomationId={automationdIds.subtitleAutomationId} sectionTitleAutomationId={automationdIds.sectionTitleAutomationId} sectionTitleDescriptionAutomationId={automationdIds.sectionTitleDescriptionAutomationId} breadcrumbAutomationId={automationdIds.breadcrumbAutomationId} breadcrumbTextAutomationId={automationdIds.breadcrumbTextAutomationId}>
            Example
          </TitleBlockZen>);
                for (const automationId of Object.values(automationdIds)) {
                    expect(container.querySelector(`[data-automation-id="${automationId}"]`)).toBeTruthy();
    ...
    describe("breadcrumb", () => {
        it("renders a link when you pass a path prop", () => {
            render(<TitleBlockZen title="Test Title" breadcrumb={{
                    text: "Back",
        ...
        it("renders a custom component when you pass a 'render' prop", async () => {
            ...
            <div data-automation-id="custom-component" data-testid="custom-component" onClick={props.breadcrumb.handleClick}>
          {props.children}
        </div>);
            render(<TitleBlockZen title="Test Title" breadcrumb={{
                    text: "Back",
    ...
    describe("renders a custom component when you pass a 'component' prop to a action", () => {
        const MockLinkComponent = (props: any): JSX.Element => (<a className={props.className} href={props.href} data-testid={props["data-testid"]}>
        {props.children}
      </a>);
        const MockButtonComponent = (props: any): JSX.Element => (<button type="button" className={props.className} onClick={props.onClick} data-testid={props["data-testid"]}>
        {props.children}
      </button>);
        describe("primaryAction", () => {
            it("will render a custom anchor component in the main action toolbar", () => {
                render(<TitleBlockZen title="Test Title" primaryAction={{
            ...
            Example
                ...
                expect(within(toolbar).getByRole("link", {
                    name: "Primary action",
            ...
            it("will render custom button with children and not label", () => {
                ...
                render(<TitleBlockZen title="Test Title" primaryAction={{
                        label: "Primary action",
                        onClick: testClickFunc,
                        component: (props): JSX.Element => (<MockButtonComponent {...props}>
        ...
        describe("secondaryActions", () => {
            it("will render multiple custom anchor components in the secondary actions toolbar", () => {
                render(<TitleBlockZen title="Test Title" secondaryActions={[
                        {
        ...
        describe("defaultAction", () => {
            it("will render a custom anchor components in the main action toolbar", () => {
                render(<TitleBlockZen title="Test Title" defaultAction={{
