import { Canvas, DocsStory, Meta } from "@storybook/blocks"
...
<DocsStory of={TitleBlockZenStories.WithBadge} />

<DocsStory of={TitleBlockZenStories.WithDefaultTag} />

<DocsStory of={TitleBlockZenStories.WithAvatarProps} />

<DocsStory of={TitleBlockZenStories.WithMenuButton} />

<DocsStory of={TitleBlockZenStories.Subtitle} />
