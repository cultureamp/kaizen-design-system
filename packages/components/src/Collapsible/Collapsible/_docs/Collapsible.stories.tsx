...
export const NoPadding: Story = {
    ...
    render: ({ title }) => (<Collapsible open noSectionPadding title={title}>
      <Text variant="body">
...
export const Clear: Story = {
    ...
    render: ({ title }) => (<Collapsible open variant="clear" title={title}>
...
export const CustomHeader: Story = {
    ...
    render: ({ title: standardTitle }) => (<Collapsible open title={standardTitle} renderHeader={title => (<Heading variant="heading-4" tag="span">
...
export const Sticky: Story = {
    ...
    render: ({ title }) => (<Collapsible open title={title} sticky={{ top: "-1px" }}>
