...
const CollapsibleWrapped = (args: Omit<CollapsibleProps, "children">): JSX.Element => (<Collapsible open {...args}>
    ...
    render: () => (<StickerSheet>
      <StickerSheet.Body>
        ...
        <StickerSheet.Row rowTitle="custom heading">
          <CollapsibleWrapped title="Custom header" renderHeader={title => (<Heading variant="heading-4" tag="span">
                {title}
              </Heading>)}/>
        </StickerSheet.Row>
      </StickerSheet.Body>
