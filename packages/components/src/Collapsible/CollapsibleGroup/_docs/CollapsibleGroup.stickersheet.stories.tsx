...
const CollapsibleWrapped = (args: Omit<CollapsibleProps, "children" | "title">): JSX.Element => (<Collapsible title="Title" open {...args}>
...
const CollapsibleGroupWrapped = (args: Omit<CollapsibleGroupProps, "children">): JSX.Element => (<CollapsibleGroup {...args}>
