 ...
 */
export const CollapsibleGroup = ({ children, separated = false, sticky, noSectionPadding = false, lazyLoad = false, onToggle, classNameOverride, ...props }: CollapsibleGroupProps): JSX.Element => (<div className={classnames(classNameOverride, !separated && styles.container)} {...props}>
    {React.Children.map(children, collapsible => React.cloneElement(collapsible, {
        group: true,
        separated,
        sticky,
        noSectionPadding,
