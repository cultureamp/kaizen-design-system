...
const CalendarWrapper = (props: Partial<CalendarSingleProps>): JSX.Element => (<CalendarSingle id="calendar-dialog" onDayClick={jest.fn()} locale={enUS} onMount={calendarElement => setFocusInCalendar(calendarElement, props.selected)} {...props}/>);
