...
import { autoUpdate, offset, useFloating, UseFloatingOptions, size, autoPlacement, } from "@floating-ui/react-dom";
 ...
 */
export const CalendarPopover = ({ children, referenceElement, floatingOptions, classNameOverride, ...restProps }: CalendarPopoverProps): JSX.Element => {
    ...
    return (<div ref={setFloatingElement} style={floatingStyles} className={classnames(styles.calendarPopover, classNameOverride)} role="dialog" aria-modal="true" {...restProps}>
      {children}
    </div>);
};
