...
const CalendarSingleExample = (props: Partial<CalendarSingleProps>): JSX.Element => (<div data-testid={props.id}>
...
const StickerSheetTemplate: StickerSheetStory = {
    render: () => (<>
      <StickerSheet heading="Calendars - Day">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            <CalendarSingleExample disabled={[
            new Date("2021-09-15"),
      ...
      <StickerSheet heading="Calendars - Selected Day">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            <CalendarSingleExample selected={new Date("2021-09-05")} id="id--calendar-selected--hover"/>
            <CalendarSingleExample selected={new Date("2021-09-05")} id="id--calendar-selected--focus"/>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
      ...
      <StickerSheet heading="Calendars - Today">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            <CalendarSingleExample defaultMonth={new Date("2022-05-01")} id="id--calendar-today--default"/>
            <CalendarSingleExample defaultMonth={new Date("2022-05-01")} id="id--calendar-today--selected" selected={new Date("2022-05-01")}/>
            <CalendarSingleExample defaultMonth={new Date("2022-05-01")} id="id--calendar-today--disabled" selected={new Date("2022-05-01")} disabled={[new Date("2022-05-01")]}/>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
...
const applyStickerSheetStyles = (canvasElement: HTMLElement): void => {
    ...
    calendarsPseudoStates.forEach(({ id, role, name }) => {
        getElementWithinCalendar(`${id}--hover`, role, name).setAttribute("data-sb-pseudo-styles", "hover");
        getElementWithinCalendar(`${id}--focus`, role, name).setAttribute("data-sb-pseudo-styles", "focus");
    });
};
