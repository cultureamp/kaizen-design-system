...
const PopoverWrapper = (props: Omit<PopoverProps, "children" | "referenceElement">): JSX.Element => {
...
const PopoverRow = ({ placement, }: {
    placement?: PopoverProps["placement"];
}): JSX.Element => (<StickerSheet.Row rowTitle={placement}>
...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => (<StickerSheet isReversed={isReversed}>
      ...
      <StickerSheet.Body>
        ...
        <>
          {popoverPlacements.map(placement => (<PopoverRow key={placement} placement={placement}/>))}
        </>
      </StickerSheet.Body>
    </StickerSheet>),
};
