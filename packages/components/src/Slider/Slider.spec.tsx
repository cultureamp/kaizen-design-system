...
describe("<Slider />", () => {
    ...
    it("renders the description when provided", async () => {
        render(<Slider labelText="Work overall" description="General feeling about work" id="unique-1" minLabel="Awful" maxLabel="Fantastic"/>);
    ...
    it("renders read only message when provided", async () => {
        render(<Slider labelText="Work overall" id="unique-1" minLabel="Awful" maxLabel="Fantastic" readOnlyMessage="Waiting for Sally to respond"/>);
