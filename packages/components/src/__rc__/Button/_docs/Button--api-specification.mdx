...
<Meta title="Components/Button/Button (v3)/API Specification" />
...
A separate <LinkTo pageId="actions-linkbutton-linkbutton-v3-api-specification--docs">LinkButton</LinkTo> component has been created to handle page navigation and client side routing.
