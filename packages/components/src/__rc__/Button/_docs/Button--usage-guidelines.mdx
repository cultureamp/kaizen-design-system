...
Do: [Example showing a single primary "Submit" button with a tertiary ‘Cancel’ button]
Don't: [Example showing "Submit" and "Cancel" buttons next to each other both using the primary style]

<DosAndDonts>
  <DoOrDont story={Button.Playground} />
  <DoOrDont story={Button.Playground} isDont />
</DosAndDonts>
...
[Do example - Empty state with CTA button]
...
[Do example - Select with ‘Choose country’ with Primary Medium size ‘Save’ button ]
[Don’t example - Select with ‘Choose country’ with Primary Small size ‘Save’ button ]
...
Ensure clarity by prioritizing the most important actions
Think about how many buttons you use and where you put them. Don't overload your interface with too many buttons, as clustering buttons can confuse people.
...
[Do example - Button with + icon and ‘Add user’]
[Don’t example - Button with star icon and ‘Add user’]
...
[Do example - Button with trash icon with ‘Delete’ tooltip ]
[Don’t example - Button with trash icon and no tooltip]
...
[Do example - Secondary Menu button (button with chevron) with ‘Manage’]
...
[Do example - Secondary overflow Menu button (kabab icon only) with ‘Manage’ tooltip]
...
[Do example - Button with ‘Save’]
[Don’t example - Button with ‘Go to next step’]
...
[Do example - Button with ‘Create survey’]
[Don’t example - Button with ‘Create’]
...
[Do example - Button with ‘View tour’]
[Don’t example - Button with ‘What’s new?’]
...
[Do example - Button with ‘View your reports’]
[Don’t example - Button with ‘View my reports’]
...
[Do example - Button with ‘Edit report’’]
[Don’t example - Button with ‘Edit’]
