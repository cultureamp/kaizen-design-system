    ...
    render: ({ isReversed }) => (<StickerSheet isReversed={isReversed}>
      ...
      <StickerSheet.Body>
        <StickerSheet.Row rowTitle="off">
          ...
          <ToggleSwitchField labelText="Toggle me" reversed={isReversed} data-sb-pseudo-styles="hover"/>
          <ToggleSwitchField labelText="Toggle me" reversed={isReversed} data-sb-pseudo-styles="focus"/>
        ...
        <StickerSheet.Row rowTitle="on">
          ...
          <ToggleSwitchField labelText="Toggle me" toggledStatus="on" reversed={isReversed} data-sb-pseudo-styles="hover"/>
          <ToggleSwitchField labelText="Toggle me" toggledStatus="on" reversed={isReversed} data-sb-pseudo-styles="focus"/>
          <ToggleSwitchField labelText="Toggle me" toggledStatus="on" reversed={isReversed} disabled/>
        </StickerSheet.Row>
      </StickerSheet.Body>
    </StickerSheet>),
    parameters: {
