...
import { CautionIcon, ExclamationIcon, InformationIcon, SuccessIcon, LiveIcon, } from "~components/Icon";
...
const LiveIconComponent = (): JSX.Element => (<span className={styles.liveIcon}>
...
export const StatusMigration: StoryObj = {
    ...
    decorators: [
        Story => (<div className="flex gap-12">
        <Story />
      </div>),
    ],
};
