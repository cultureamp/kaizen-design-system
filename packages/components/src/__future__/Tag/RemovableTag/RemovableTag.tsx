...
export const RemovableTag = ({ children, classNameOverride, 
// Note: We've commented out color support for now, but may introduce it back in later
// if a good use case comes along.
// color = "gray",
removeButtonProps, ...restProps }: RemovableTagProps): JSX.Element => (<Tag classNameOverride={classNames(classNameOverride, styles.removableTag)} 
// color={color}
{...restProps}>
    {children}
    <RemoveButton 
