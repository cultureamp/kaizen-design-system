      ...
      <StickerSheet heading="Button Group">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            <RemovableTag data-sb-pseudo-styles="hover" removeButtonProps={{
            ariaLabel: "Remove tag",
            onClick: () => alert("clicked"),
        }}>
              My tag
            </RemovableTag>
            <RemovableTag data-sb-pseudo-styles="focus" removeButtonProps={{
            ariaLabel: "Remove tag",
            onClick: () => alert("clicked"),
        }}>
              My tag
            </RemovableTag>
            <RemovableTag data-sb-pseudo-styles="focus-visible" removeButtonProps={{
            ariaLabel: "Remove tag",
            onClick: () => alert("clicked"),
        }}>
              My tag
