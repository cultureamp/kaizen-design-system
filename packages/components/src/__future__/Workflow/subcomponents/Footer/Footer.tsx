...
import { FooterRoot, FooterAction, ProgressStepper, ProgressStepperProps, FooterRootProps, } from "./components";
...
} & ProgressStepperProps & OverrideClassName<Omit<FooterRootProps, "children">>;
export const Footer = ({ steps, currentStepId, isComplete, previousAction, nextAction, ...restProps }: FooterProps): JSX.Element => (<FooterRoot {...restProps}>
