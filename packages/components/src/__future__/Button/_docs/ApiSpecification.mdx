...
<Meta title="Actions/Button/Future/API Specification" />

<SbContent>
  # Button API Specification (future)
...
<Canvas of={docsStories.Playground} />
...
<Controls of={docsStories.Playground} className="mb-64" />
...
<Canvas of={docsStories.ButtonWithIcon} />
...
<Canvas of={docsStories.IconButton} className="mb-32" />
...
<SbContent className="mb-64">
  ...
  <Canvas className="bg-purple-600 mb-24" of={docsStories.OnReversed} />
