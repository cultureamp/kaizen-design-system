...
export const SelectPopoverContents = <Option extends SelectOption>({ children, menuProps, }: SelectPopoverContentsProps<Option>): JSX.Element => {
    ...
    // - Option => Item
    const itemNodes = Array.from(state.collection) as Array<SelectItemNode<Option>>;
    return (<div className={styles.selectPopoverContents}>
      <Overlay<Option>>
