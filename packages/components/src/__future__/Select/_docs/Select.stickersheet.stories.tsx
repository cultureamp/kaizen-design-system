...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => (<>
      <StickerSheet isReversed={isReversed} heading="Select">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            <StickerSheet.Cell style={{ verticalAlign: "top" }}>
              <Select label="Label" items={singleMockItems} selectedKey="mocha" isReversed={isReversed}/>
            </StickerSheet.Cell>
            <StickerSheet.Cell style={{ verticalAlign: "top" }}>
              <Select label="Label" items={singleMockItems} description="This is a description" selectedKey="mocha" isReversed={isReversed}/>
            </StickerSheet.Cell>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
      ...
      <StickerSheet isReversed={isReversed} heading="Pseudo states">
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            <Select label="Label" items={singleMockItems} isReversed={isReversed} data-sb-pseudo-styles="hover"/>
            <Select label="Label" items={singleMockItems} isReversed={isReversed} data-sb-pseudo-styles="active"/>
            <Select label="Label" items={singleMockItems} isReversed={isReversed} data-sb-pseudo-styles="focus"/>
      ...
      <StickerSheet isReversed={isReversed} heading="Width" width="100%">
        <StickerSheet.Body>
          ...
          <StickerSheet.Row>
            <div style={{ width: "50%" }}>
              <Select label="Custom Width (50%)" items={singleMockItems} isFullWidth isReversed={isReversed}/>
            </div>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
      ...
      <StickerSheet isReversed={isReversed} heading="Validation">
        <StickerSheet.Body>
          <StickerSheet.Row>
            <Select label="Error" items={singleMockItems} description="This is a description" status="error" validationMessage="This is an error" isReversed={isReversed}/>
            <Select label="Caution" items={singleMockItems} description="This is a description" status="caution" validationMessage="This is an error" isReversed={isReversed}/>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
      ...
      <StickerSheet isReversed={isReversed} heading="Truncated">
        ...
        ]} selectedKey="id-long" isReversed={isReversed}/>
          </StickerSheet.Row>
        </StickerSheet.Body>
      </StickerSheet>
    </>),
      ...
      <StickerSheet heading="Default options" style={{ paddingBottom: IS_CHROMATIC ? "26rem" : undefined }}>
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            <StickerSheet.Cell style={{ width: "250px" }}>
              <Select label="Label" defaultOpen={IS_CHROMATIC} items={singleMockItems} selectedKey="mocha"/>
            </StickerSheet.Cell>
            <StickerSheet.Cell style={{ width: "250px" }}>
      ...
      <StickerSheet heading="Customised options" style={{ paddingTop: IS_CHROMATIC ? "26rem" : undefined }}>
        ...
        <StickerSheet.Body>
          <StickerSheet.Row>
            ...
            if (item.type === "item") {
                return (<Select.Option key={item.key} item={{
                        ...item,
                        rendered: (<div>
                                <div style={{
                                fontSize: "0.75rem",
            ...
            if (item.type === "section" && item.key === "Syrup") {
                return (<Select.Section key={item.key} section={{
                        ...item,
            ...
            <StickerSheet.Cell style={{ width: "250px" }}>
              <Select label="Label" defaultOpen={IS_CHROMATIC} items={[
