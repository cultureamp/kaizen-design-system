...
export const useSelectContext = <Option extends SelectOption = SelectOption>(): SelectContextValue<Option> => {
...
export const SelectProvider = <Option extends SelectOption = SelectOption>({ children, state, }: SelectProviderProps<Option>): JSX.Element => (<SelectContext.Provider value={{ state }}>{children}</SelectContext.Provider>);
