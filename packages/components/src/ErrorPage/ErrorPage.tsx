...
export const ErrorPage = ({ code, title, message, callToAction, classNameOverride, }: ErrorPageProps): JSX.Element => {
    ...
    return (<div className={classNames(classNameOverride)}>
      <BrandMoment header={<></>} body={<>
            ...
            <Text color="dark-reduced-opacity" variant="small">
              <FormattedMessage id="kzErrorPage.errorCode" defaultMessage="Error code {code}" values={{ code }}/>
            </Text>
          </>} illustration={<BrandMomentError isAnimated loop/>} mood="negative" primaryAction={{
            ...actions.primary,
