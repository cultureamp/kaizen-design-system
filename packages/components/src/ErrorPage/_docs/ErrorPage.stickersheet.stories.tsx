...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => (<>
      {ERROR_CODES.map(code => (<StickerSheet key={code} heading={`Error ${code}`} isReversed={isReversed}>
          <StickerSheet.Body>
            <StickerSheet.Row>
              <ErrorPage code={code}/>
            </StickerSheet.Row>
      ...
      <StickerSheet heading="Custom error" isReversed={isReversed}>
        <StickerSheet.Body>
          <StickerSheet.Row>
            <ErrorPage code="400" title="This is a 400 custom title" message="This is a custom 400 message" callToAction={{
