...
<KAIOInstallation exportNames="Tag" family="content" version="2" />
...
See our [full guide](?path=/docs/content-tag-v2-tag-migration-guide--docs) here to migrate to the future release of `Tag`.
