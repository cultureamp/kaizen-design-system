...
<Meta title="Utilities/KaizenProvider/Internationalization in Kaizen" />
...
- Wrapping your app in the <LinkTo pageId="utilities-kaizenprovider-installation">KaizenProvider</LinkTo>
