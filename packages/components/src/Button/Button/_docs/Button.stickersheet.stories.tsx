...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => {
        ...
        <StickerSheet heading="Button" isReversed={isReversed}>
          <StickerSheet.Header headings={["Base", "Hover", "Active", "Focus", "Disabled"]} headingsWidth="10rem" hasVerticalHeadings verticalHeadingsWidth="12rem"/>
          <StickerSheet.Body>
        ...
        <StickerSheet isReversed={isReversed} heading="Size small (formerly form)">
          <StickerSheet.Header headings={["Base", "Hover", "Active", "Focus", "Disabled"]} hasVerticalHeadings/>
          <StickerSheet.Body>
            {VARIANTS_PROPS.map(({ title, props }) => (<StickerSheet.Row key={title} rowTitle={title}>
                <Button reversed={isReversed} {...props} size="small"/>
                <Button reversed={isReversed} data-sb-pseudo-styles="hover" {...props} size="small"/>
                <Button reversed={isReversed} data-sb-pseudo-styles="active" {...props} size="small"/>
        ...
        <StickerSheet isReversed={isReversed} heading="With Icon / Badge">
          <StickerSheet.Header headings={[
                ...
                "Badge Only",
            ]} headingsWidth="10rem" hasVerticalHeadings verticalHeadingsWidth="12rem"/>
          <StickerSheet.Body>
            {VARIANTS_PROPS.map(({ title, props }) => (<StickerSheet.Row key={title} rowTitle={title}>
...
const WorkingStickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => {
        ...
        return (<>
        <StickerSheet heading="Button" isReversed={isReversed}>
          <StickerSheet.Header headings={["Working", "Working (Focus)"]} headingsWidth="10rem" hasVerticalHeadings verticalHeadingsWidth="12rem"/>
          <StickerSheet.Body>
            {VARIANTS_PROPS.map(({ title, props }) => (<StickerSheet.Row key={title} rowTitle={title}>
                <Button reversed={isReversed} {...props} {...WORKING_PROPS}/>
                <Button reversed={isReversed} data-sb-pseudo-styles="focus" {...props} {...WORKING_PROPS}/>
              </StickerSheet.Row>))}
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet isReversed={isReversed} heading="Size small (formerly form)">
          ...
          <StickerSheet.Body>
            {VARIANTS_PROPS.map(({ title, props }) => (<StickerSheet.Row key={title} rowTitle={title}>
                ...
                <Button reversed={isReversed} {...props} size="small" data-sb-pseudo-styles="focus" {...WORKING_PROPS}/>
              </StickerSheet.Row>))}
          </StickerSheet.Body>
        </StickerSheet>
      </>);
