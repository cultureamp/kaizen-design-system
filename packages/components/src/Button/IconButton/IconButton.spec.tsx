...
describe("<IconButton />", () => {
    ...
    it("renders an accessible label when it's a button", () => {
        const { getByLabelText } = render(<IconButton onClick={(): void => undefined} label="Accessible label on the button version"/>);
    ...
    it("renders an accessible label when it's a custom component", () => {
        const CustomComponent = (buttonProps: CustomButtonProps): JSX.Element => (<div {...buttonProps}/>);
        const { getByLabelText } = render(<IconButton component={CustomComponent} label="Accessible label on the custom component version"/>);
