 ...
 * dom.
 */
export const AppearanceAnim = ({ children, isVisible, className, ...rest }: AppearanceAnimProps): JSX.Element | null => {
    ...
    const trackAnimOutCompleted = useDebouncedCallback(() => {
        setIsAnimOut(false);
    }, ANIM_DURATION_MS + ANIM_BUFFER, { leading: false });
    ...
    return isVisible || isAnimOut || isAnimIn ? (<div className={classnames([
            {
