...
export const TimeSegment = ({ segment, state, }: TimeSegmentProps): JSX.Element => {
    ...
    return (<span className={styles.timeSegmentWrapper}>
      &#8203;
      <span {...segmentProps} ref={ref} className={classnames(styles.timeSegment, segment.type === "literal" && styles.literal, segment.isPlaceholder && styles.placeholder, segment.type === "dayPeriod" && styles.dayPeriod)}>
