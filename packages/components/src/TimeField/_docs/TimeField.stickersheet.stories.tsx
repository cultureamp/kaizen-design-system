...
const StickerSheetTemplate: StickerSheetStory = {
    render: () => {
          ...
          <StickerSheet.Body>
            <StickerSheet.Row>
              <StickerSheet.Cell className="align-top">
                <TimeField label="Label (en-AU)" locale="en-AU" value={valueDefault} onChange={setValueDefault}/>
              </StickerSheet.Cell>
              <StickerSheet.Cell className="align-top">
                <TimeField label="Label (en-AU)" locale="en-AU" value={{ hour: 1, minutes: 30 }} onChange={(): void => undefined} isDisabled/>
              </StickerSheet.Cell>
              <StickerSheet.Cell className="align-top">
                <TimeField label="Label (en-AU)" locale="en-AU" value={valueError} onChange={setValueError} status="error" validationMessage="Date is invalid"/>
              </StickerSheet.Cell>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet heading="Pseudo states" className="w-full">
          ...
          <StickerSheet.Body>
            <StickerSheet.Row>
              <TimeField label="Label (hover on hour)" locale="en-AU" value={{ hour: 22, minutes: 30 }} onChange={(): void => undefined} data-sb-pseudo-styles="hover--segment"/>
              <TimeField label="Label (focus on hour)" locale="en-AU" value={{ hour: 22, minutes: 30 }} onChange={(): void => undefined} data-sb-pseudo-styles="focus--segment"/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
