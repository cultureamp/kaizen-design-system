...
const DateRangePickerWrapper = (props: Partial<DateRangePickerProps>): JSX.Element => {
    ...
    return (<DateRangePicker id="test__date-range-picker" labelText="Choose date" onChange={onDateRangeChange} value={value} defaultMonth={new Date("2022-03-01")} selectedDateRange={selectedDateRange} {...restProps}/>);
};
