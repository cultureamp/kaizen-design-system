...
const DateRangePickerTemplate: Story = {
    render: args => {
        ...
        return (<>
        <DateRangePicker {...args} value={value} selectedDateRange={selectedDateRange} onChange={onDateRangeChange}/>
      </>);
    },
};
