...
<img src={AnatomyPng} alt="Indicates the anatomy of the Tooltip component, the Container, Label, Arrow and Trigger" className="mb-64" />
...
<img src={WhenToUse} alt="Illustration of when to use the Tooltip component" className="mb-32"/>
    ...
    <div className="flex m-0">
      <div className="m-0 w-1/3 flex flex-col gap-16">
        ...
        <div className="bg-gray-500 absolute top-6 left-6 z-10 py-4 px-6 font-bold text-white rounded flex gap-2 items-center justify-center">
            ...
            <Text variant="body" tag="span" color="white"><strong>Don&apos;t</strong></Text>
          </div>
          <Canvas of={TooltipUsageGuidanceStories.DontFieldTooltip} className="border-gray-500 !rounded-[10px]" />
        </div>
      </div>
      <div className="ml-16 w-2/3">
        <Heading tag="h4" variant="heading-4">Don&apos;t use tooltips to communicate crucial information</Heading>
        <Text variant="body" tag="span">
