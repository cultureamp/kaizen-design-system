...
import VariantsPng from "./assets/tooltip_variant.png"
...
<img src={WhenToUsePng} alt="Illustration of when to use the Tooltip component" className="mb-24"/>
...
<img src={Trigger1Png} alt="Indicates the anatomy of the Tooltip component, the Container, Label, zArrow and Trigger" className="mb-24" />
...
<img src={Trigger2Png} alt="Indicates the anatomy of the Tooltip component, the Container, Label, zArrow and Trigger" className="mb-24" />
...
<img src={Trigger3Png} alt="Indicates the anatomy of the Tooltip component, the Container, Label, zArrow and Trigger" className="mb-24" />
