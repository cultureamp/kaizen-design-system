...
export type MenuProps = Omit<StatelessMenuProps, "renderButton" | "hideMenuDropdown" | "toggleMenuDropdown" | "isMenuVisible"> & {
    /**
...
export const Menu = ({ button, menuVisible = false, ...rest }: MenuProps): JSX.Element => {
    ...
    return (<StatelessMenu {...rest} isMenuVisible={isMenuVisible} toggleMenuDropdown={toggleMenuDropdown} hideMenuDropdown={hideMenuDropdown} 
    ...
    renderButton={(props): JSX.Element => React.cloneElement(button, {
            ...props,
