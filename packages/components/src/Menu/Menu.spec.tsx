...
describe("Dropdown", () => {
    it("shows menu when clicking on the button", async () => {
        render(<Menu button={<Button label="Button"></Button>}>
        <div>Item</div>
      </Menu>);
    ...
    it("shows menu & handles onClick set by the consumer when clicking on the button", async () => {
        ...
        render(<Menu button={<Button label="Button" onClick={onButtonClick}/>}>
        <div>Item</div>
      </Menu>);
    ...
    it("shows menu & handles onMouseDown set by the consumer when mousing down on the button", async () => {
        ...
        render(<Menu button={<Button label="Button" onMouseDown={onMouseDown}/>}>
        <div>Item</div>
      </Menu>);
        expect(screen.queryByText("Item")).not.toBeInTheDocument();
        const button = screen.getByText("Button");
