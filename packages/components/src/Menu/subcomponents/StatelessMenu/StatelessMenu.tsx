...
export const StatelessMenu = ({ align = "left", dropdownWidth = "default", autoHide = "on", "data-testid": dataTestId, dropdownId, children, portalSelector, isMenuVisible, toggleMenuDropdown, hideMenuDropdown, renderButton, onClick, }: StatelessMenuProps): JSX.Element => {
    ...
    const menu = isMenuVisible ? (<MenuDropdown referenceElement={referenceElement} align={align} hideMenuDropdown={hideMenuDropdown} width={dropdownWidth} id={dropdownId} autoHide={autoHide}>
      {children}
    </MenuDropdown>) : null;
    return (
