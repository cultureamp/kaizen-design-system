...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => {
        ...
        <StickerSheet isReversed={isReversed} heading="DatePicker">
          ...
          <StickerSheet.Body>
            <StickerSheet.Row style={{ verticalAlign: "top" }}>
              <DatePicker labelText="Label" selectedDay={selectedDate} onDayChange={setValueDate} isReversed={isReversed}/>
              <DatePicker labelText="Label" selectedDay={new Date(2022, 1, 5)} onDayChange={() => undefined} isReversed={isReversed}/>
              <DatePicker labelText="Label" selectedDay={undefined} onDayChange={() => undefined} isReversed={isReversed} description={<>
                    <Text tag="span" variant="small" color={isReversed ? "white" : "dark"}>
                      My <strong>Custom</strong> Description
                    </Text>
                  </>}/>
              <DatePicker labelText="Label" selectedDay={undefined} onDayChange={() => undefined} isReversed={isReversed} disabled/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet isReversed={isReversed} heading="Pseudo states">
          ...
          <StickerSheet.Body>
            <StickerSheet.Row rowTitle="Container">
              <DatePicker isReversed={isReversed} labelText="Date" selectedDay={undefined} onDayChange={() => undefined} data-sb-pseudo-styles="hover"/>
              <DatePicker isReversed={isReversed} labelText="Date" selectedDay={undefined} onDayChange={() => undefined} data-sb-pseudo-styles="focus"/>
            </StickerSheet.Row>

            <StickerSheet.Row rowTitle="Icon button">
              <DatePicker isReversed={isReversed} labelText="Date" selectedDay={undefined} onDayChange={() => undefined} classNameOverride="story__date-input-single-field--hover"/>
              <DatePicker isReversed={isReversed} labelText="Date" selectedDay={undefined} onDayChange={() => undefined} classNameOverride="story__date-input-single-field--focus"/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet isReversed={isReversed} heading="Validation">
          ...
          <StickerSheet.Body>
            <StickerSheet.Row>
              <DatePicker labelText="Label" selectedDay={new Date("potato")} onDayChange={() => undefined} isReversed={isReversed}/>
              <DatePicker labelText="Label" selectedDay={undefined} onDayChange={() => undefined} isReversed={isReversed} status="caution" validationMessage="Custom cautionary message"/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
      </>);
