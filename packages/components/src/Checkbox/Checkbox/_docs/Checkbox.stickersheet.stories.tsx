    ...
    render: ({ isReversed }) => {
        ...
        <StickerSheet.Body>
          {rows.map(({ title, checkedStatus }) => (<StickerSheet.Row key={title} rowTitle={title}>
              ...
              <Checkbox {...defaultProps} checkedStatus={checkedStatus} data-sb-pseudo-styles="hover"/>
              <Checkbox {...defaultProps} checkedStatus={checkedStatus} data-sb-pseudo-styles="focus"/>
