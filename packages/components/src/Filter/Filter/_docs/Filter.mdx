...
These components are mainly used for constructing Filter components (eg. <LinkTo pageId="pickers-filterselect">FilterSelect</LinkTo>):
- <LinkTo pageId="pickers-filter-filterbutton">FilterButton</LinkTo> for the renderTrigger
...
A callback that provides trigger button props to the provided <LinkTo pageId="pickers-filter-filterbutton">FilterButton</LinkTo>.
