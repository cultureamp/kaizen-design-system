...
import { MenuTriggerConsumer, MenuTriggerProvider, MenuTriggerProviderContextType, MenuTriggerProviderProps, SelectionConsumer, SelectionProvider, SelectionProviderContextType, } from "./context";
...
export const FilterMultiSelect = ({ trigger, children, isOpen, defaultOpen, onOpenChange, isLoading, loadingSkeleton, label, items, selectedKeys, defaultSelectedKeys, onSelectionChange, selectionMode = "multiple", onSearchInputChange, }: FilterMultiSelectProps): JSX.Element => {
    const menuTriggerProps = { isOpen, defaultOpen, onOpenChange };
    const menuPopupProps = { isLoading, loadingSkeleton };
    const disabledKeys: Selection = new Set(items
    ...
    return (<MenuTriggerProvider {...menuTriggerProps}>
      <div>
