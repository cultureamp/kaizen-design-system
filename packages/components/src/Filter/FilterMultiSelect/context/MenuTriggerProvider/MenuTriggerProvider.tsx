...
const MenuTriggerContext = React.createContext<MenuTriggerProviderContextType>({} as MenuTriggerProviderContextType);
export function MenuTriggerProvider({ isOpen, defaultOpen, onOpenChange, children, }: MenuTriggerProviderProps): JSX.Element {
    ...
    return (<MenuTriggerContext.Provider value={{
            menuTriggerProps,
            buttonProps,
            menuProps,
...
export const MenuTriggerConsumer = ({ children, }: React.ConsumerProps<MenuTriggerProviderContextType>): JSX.Element => (<MenuTriggerContext.Consumer>{children}</MenuTriggerContext.Consumer>);
