...
const MenuTriggerProviderWrapper = (props: Partial<MenuTriggerProviderProps>): JSX.Element => (<MenuTriggerProvider {...props}>
    <FilterTriggerButton label="trigger-display-label-mock" selectedOptionLabels={[]} // This is irrelevant as we are not testing the button contents
/>
    <MenuPopup>
...
describe("<MenuTriggerProvider /> - Visual content", () => {
    ...
    describe("when controlled", () => {
        ...
        it("fires the onOpenChange callback when the trigger is interacted", async () => {
            const onOpenChange = jest.fn<void, [
                boolean
            ]>();
