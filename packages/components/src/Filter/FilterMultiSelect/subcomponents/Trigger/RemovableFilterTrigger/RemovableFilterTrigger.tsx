...
export const RemovableFilterTrigger = ({ label, selectedOptionLabels, labelCharacterLimitBeforeTruncate = 50, classNameOverride, onRemove, }: RemovableFilterTriggerProps): JSX.Element => {
    const { buttonProps, buttonRef, menuTriggerState } = useMenuTriggerContext();
    const ref = useRef<FilterTriggerRef>({ triggerRef: buttonRef });
    return (<FilterButtonRemovable ref={ref} classNameOverride={classNameOverride} triggerButtonProps={{
            ...buttonProps,
            label,
