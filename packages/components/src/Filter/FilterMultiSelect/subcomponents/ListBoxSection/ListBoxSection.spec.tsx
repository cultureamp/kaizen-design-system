...
describe("<ListBoxSection />", () => {
    describe("sectionName only", () => {
        it("will only have aria-label", () => {
            const { getByRole } = render(<ListBoxSection sectionName="Test sectionName only" items={[]}>
          {() => undefined}
        </ListBoxSection>);
    ...
    describe("sectionHeader only", () => {
        it("will have sectionHeader content", () => {
            const { getByRole } = render(<ListBoxSection sectionHeader="Test sectionHeader only" items={[]}>
          {() => undefined}
        </ListBoxSection>);
    ...
    describe("sectionHeader and sectionName", () => {
        it("will have combined accessible name", () => {
            const { getByRole } = render(<ListBoxSection sectionName="Hidden group name" sectionHeader="sectionHeader name" items={[]}>
          {() => undefined}
        </ListBoxSection>);
            const group = getByRole("group", {
