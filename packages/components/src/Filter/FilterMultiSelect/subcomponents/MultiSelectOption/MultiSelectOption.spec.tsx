...
const itemMock: MultiSelectOptionProps["item"] & {
    value: ItemType;
} = {
    type: "type-mock",
    key: "key-mock",
...
const MultiSelectOptionWrapper = ({ item = itemMock, }: Partial<MultiSelectOptionProps>): JSX.Element => (<MultiSelectOption item={item}/>);
describe("<MultiSelectOptionWrapper /> - Visual content", () => {
    ...
    describe("Given count is provided", () => {
        beforeEach(() => {
            ...
            render(<MultiSelectOptionWrapper item={{
                    ...itemMock,
