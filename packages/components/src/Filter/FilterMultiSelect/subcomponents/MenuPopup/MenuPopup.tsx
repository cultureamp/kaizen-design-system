...
export const MenuPopup = ({ isLoading, loadingSkeleton, children, }: MenuPopupProps): JSX.Element => {
    ...
    return menuTriggerState.isOpen ? (<div {...overlayProps} ref={overlayRef} className={styles.menuPopup}>
