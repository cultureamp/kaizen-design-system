...
export const SearchInput = ({ label, id, isLoading, }: SearchInputProps): JSX.Element => {
    ...
    return (<div className={styles.inputSearchContainer}>
      <InputSearch id={inputId} aria-label={label ?? defaultAriaLabel} secondary placeholder={placeholder} value={searchQuery} onChange={handleChange} onClear={handleClear} loading={isLoading}/>
    </div>);
};
