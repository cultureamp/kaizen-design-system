...
import { FilterDatePickerField, FilterDatePickerFieldProps, } from "./subcomponents/FilterDatePickerField";
...
export const FilterDatePicker = ({ isOpen, setIsOpen, renderTrigger, selectedDate, label, locale, onDateSubmit, ...restProps }: FilterDatePickerProps): JSX.Element => (<Filter isOpen={isOpen} setIsOpen={setIsOpen} renderTrigger={(triggerProps): JSX.Element => renderTrigger({
    ...
    <FilterContents>
      <FilterDatePickerField locale={locale} selectedDate={selectedDate} onDateSubmit={date => {
        setIsOpen(false);
        onDateSubmit?.(date);
    }} {...restProps}/>
    </FilterContents>
