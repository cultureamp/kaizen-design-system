...
const FilterDatePickerTemplate: Story = {
    render: args => {
        ...
        return (<FilterDatePicker {...args} isOpen={isOpen} setIsOpen={setIsOpen} selectedDate={date} onDateChange={setDate}/>);
    },
};
const sampleCode = `
...
export const RenderTrigger: Story = {
    render: () => {
        ...
        <FilterDatePicker id="filterdp--filter-button-removable" label="FilterButtonRemovable" locale="en-AU" renderTrigger={(triggerButtonProps: FilterButtonProps): JSX.Element => (<FilterButtonRemovable triggerButtonProps={{ ...triggerButtonProps }} removeButtonProps={{
                    onClick: (): void => undefined,
...
const ValidationHelpText = ({ validationResponse, }: {
...
export const Validation: Story = {
    render: () => {
        ...
        <form onSubmit={submitRequest}>
          <FilterDatePickerField id="datepicker-default" inputProps={{ labelText: "Label" }} selectedDate={value} onDateChange={setValue} onValidate={handleValidate} validationMessage={validationMessage} disabledDays={new Date()} locale="en-AU"/>
