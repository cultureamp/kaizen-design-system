...
describe("<DateRangeValidationMessage />", () => {
    describe("when the consumer has given it a node", () => {
        it("will render a single validation field message", () => {
            render(<DateRangeValidationMessage validationMessage={{
                    dateEnd: {
                        status: "error",
        ...
        it("combines multiple validation messages with the same status", () => {
            const { container } = render(<DateRangeValidationMessage validationMessage={{
                    dateStart: {
                        status: "error",
    ...
    it("renders an id when passed in", () => {
        const { container } = render(<DateRangeValidationMessage dateStartId="date-start-error-message-id" dateEndId="date-end-error-message-id" validationMessage={{
                dateStart: {
                    status: "caution",
                    message: '"Date from" is close to the submission date.',
                },
