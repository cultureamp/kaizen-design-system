...
export type UseStartDateValidationValue = {
  ...
  validateDate: (args: { date: Date | undefined; inputValue: string }) => Date | undefined
}
...
export const useStartDateValidation = (
  ...
  const validateStartDate: UseStartDateValidationValue['validateDate'] = ({ date, inputValue }) => {
