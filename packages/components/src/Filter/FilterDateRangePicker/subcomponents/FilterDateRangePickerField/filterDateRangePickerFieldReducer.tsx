...
export const filterDatePickerFieldReducer = (state: FilterDateRangePickerState, action: DateRangeFieldActions): FilterDateRangePickerState => {
    switch (action.type) {
        case "update_selected_start_date":
            return {
                ...state,
                selectedStartDate: action.date,
                inputStartValue: action.inputValue === undefined
        ...
        case "update_selected_end_date":
            return {
                ...
                inputEndValue: action.inputValue === undefined
                    ? state.inputEndValue
                    : action.inputValue,
            };
