...
const FilterDateRangePickerTemplate: Story = {
    render: args => {
        ...
        return (<FilterDateRangePicker {...args} isOpen={isOpen} setIsOpen={setIsOpen} selectedRange={range} onRangeChange={setRange}/>);
    },
};
const sampleCode = `
...
export const RenderTrigger: Story = {
    render: () => {
        ...
        <FilterDateRangePicker id="filterdrp--filter-button-removable" label="FilterButtonRemovable" locale="en-AU" renderTrigger={(triggerButtonProps: FilterButtonProps): JSX.Element => (<FilterButtonRemovable triggerButtonProps={{ ...triggerButtonProps }} removeButtonProps={{
                    onClick: (): void => undefined,
