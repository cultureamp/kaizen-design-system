...
import { ResourceLinks, KaioNotification, Installation, CustomCanvas } from "../../../../../storybook/components"
...
<CustomCanvas of={FilterStories.SimpleFilter} />

## API

<ArgTypes of={FilterStories.SimpleFilter} />
...
<CustomCanvas of={FilterStories.RemovableFilter} />
