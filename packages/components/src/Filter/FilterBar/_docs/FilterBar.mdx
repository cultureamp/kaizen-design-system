...
- `<FilterBar.DatePicker>` - extends <LinkTo pageId="pickers-filterdatepicker">FilterDatePicker</LinkTo>
  - `selectedDate` is omitted
  - `onDateChange` is now optional
  - `locale` is now optional (defaults to `"en-AU"`)
- `<FilterBar.DateRangePicker>` - extends <LinkTo pageId="pickers-filterdaterangepicker">FilterDateRangePicker</LinkTo>
  - `selectedRange` is omitted
  - `onRangeChange` is now optional
  - `locale` is now optional (defaults to `"en-AU"`)
- `<FilterBar.MultiSelect>` - extends <LinkTo pageId="pickers-filtermultiselect">FilterMultiSelect</LinkTo>
...
- `<FilterBar.Select>` - extends <LinkTo pageId="pickers-filterselect">FilterSelect</LinkTo>
