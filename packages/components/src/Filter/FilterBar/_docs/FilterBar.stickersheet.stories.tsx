...
const StickerSheetTemplate: StickerSheetStory = {
    render: () => {
        ...
        const [valuesRemovableAllActive, setValuesRemovableAllActive] = useState<Partial<ValuesRemovable>>({ topping: "pearls" });
        const [valuesRemovablePartialActive, setValuesRemovablePartialActive] = useState<Partial<ValuesRemovable>>({});
        return (<>
        <StickerSheet heading="Filter Bar" style={{ width: "100%" }}>
          <StickerSheet.Body>
            <StickerSheet.Row>
              <FilterBar<Values> filters={filters} values={activeValues} onValuesChange={setActiveValues}/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
          ...
          <StickerSheet.Body>
            <StickerSheet.Row>
              <div style={{ maxWidth: "500px" }}>
                <FilterBar<Values> filters={filters} values={activeValuesOverflow} onValuesChange={setActiveValuesOverflow}/>
              </div>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet heading="Removable; All active" style={{ width: "100%" }}>
          <StickerSheet.Body>
            <StickerSheet.Row>
              <FilterBar<ValuesRemovable> filters={removableFilters} values={valuesRemovableAllActive} onValuesChange={setValuesRemovableAllActive}/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
        ...
        <StickerSheet heading="Removable; Partial active" style={{ width: "100%" }}>
          <StickerSheet.Body>
            <StickerSheet.Row>
              <FilterBar<ValuesRemovable> filters={removableFilters} values={valuesRemovablePartialActive} onValuesChange={setValuesRemovablePartialActive}/>
            </StickerSheet.Row>
          </StickerSheet.Body>
        </StickerSheet>
      </>);
