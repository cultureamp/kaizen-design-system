...
const FilterButtonRemovableWrapper = ({ triggerButtonProps, removeButtonProps, ...restProps }: Partial<FilterButtonRemovableProps>): JSX.Element => (<FilterButtonRemovable triggerButtonProps={{
        ...triggerButtonProps,
        label: "Desserts",
    }} removeButtonProps={{
        ...removeButtonProps,
    ...
    describe("Refs", () => {
        it("correctly passes through both button refs", async () => {
            ...
            const Wrapper = (): JSX.Element => {
                ...
                return (<>
            <FilterButtonRemovable ref={ref} id="test__date-input-field--ref" triggerButtonProps={{
                        label: "Desserts",
