...
import { TableCard, TableContainer, TableHeader, TableHeaderRowCell, TableRow, TableRowCell, } from "./Table";
 ...
 */
const Wrapper = (): JSX.Element => (<TableContainer data-testid={TestId.tableContainer}>
    <TableHeader data-testid={TestId.tableHeader}>
      <TableRow data-testid={TestId.tableHeaderRow}>
        <TableHeaderRowCell checkable={true} checkedStatus="on" onCheck={(): void => undefined} onClick={(): void => undefined} labelText="Resource name" width={12 / 12} data-testid={TestId.tableHeaderRowCell}/>
      </TableRow>
    </TableHeader>
