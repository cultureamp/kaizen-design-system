...
const DEFAULT_CHILDREN: JSX.Element = (<span>
...
const VARIANTS_PROPS: Array<{
    ...
    },
    {
        ...
        props: {
            ...DEFAULT_PROPS,
            children: "Content longer that the width of the container will break onto a new line. Lorem ipsum dolor, sit amet consectetur adipisicing elit. In aperiam voluptatem molestias saepe quia vitae quod ex illum, unde nihil impedit possimus officia labore atque quidem necessitatibus sint, maiores velit.",
            type: "positive",
            headingProps: {
                variant: "heading-6",
                tag: "span",
...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => (<>
      <StickerSheet heading="Button" isReversed={isReversed}>
        <StickerSheet.Body>
          {VARIANTS_PROPS.map(({ title, props }) => (<StickerSheet.Row key={title} rowTitle={title}>
