 ...
 */
export const InlineNotification = ({ isSubtle, hideCloseIcon = false, persistent = false, classNameOverride, ...otherProps }: InlineNotificationProps): JSX.Element => (<GenericNotification style="inline" persistent={persistent || hideCloseIcon} classNameOverride={classnames(classNameOverride, [
