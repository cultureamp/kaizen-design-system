...
export const ToastNotificationsList = (): JSX.Element => {
    ...
    return createPortal(<div data-testid="toast-notifications-list" role="status" className={styles.toastNotificationsList}>
      <ToastNotificationsMap notifications={notifications} onHide={removeToastNotification} container={containers[0]}/>
    </div>, document.body);
};
