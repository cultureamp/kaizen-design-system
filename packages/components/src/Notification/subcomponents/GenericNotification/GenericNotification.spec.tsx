...
describe("<GenericNotification />", () => {
    ...
    it('begins "hidden" but transitions out of it immediately', async () => {
        const { container } = render(<GenericNotification type="positive" style="inline" title="Success">
    ...
    it("hides the notification and triggers the onHide callback when the cancel button is clicked", async () => {
        ...
        const { container, getByTestId } = render(<GenericNotification type="positive" style="inline" title="Success" onHide={onHide}>
        Notification Text
      </GenericNotification>);
