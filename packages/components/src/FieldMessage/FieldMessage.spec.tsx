...
const FieldMessageWrapper = (props: Partial<FieldMessageProps>): JSX.Element => (<FieldMessage id={defaultFieldMessageProps.id} message={defaultFieldMessageProps.message} {...props}/>);
describe("<FieldMessage />", () => {
    ...
    it("renders a message within a <div> tag when not given node other than string", () => {
        const { getByText } = render(<FieldMessageWrapper message={<span>Hello I am a message within a span</span>}/>);
    ...
    it("renders an `id` attribute", () => {
        const { getByTestId } = render(<FieldMessageWrapper data-testid="id--fieldMessage" id="id--test"/>);
