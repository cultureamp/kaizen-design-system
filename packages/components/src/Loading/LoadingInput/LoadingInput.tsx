 ...
 */
export const LoadingInput = ({ isAnimated, isReversed, width, classNameOverride, height = 48, ...props }: LoadingInputProps): JSX.Element => (<div className={classnames(styles.loadingInput, isAnimated && styles.isAnimated, isReversed && styles.isReversed, classNameOverride)} style={{ width: `${width}%`, height: `${height}px` }} {...props}/>);
