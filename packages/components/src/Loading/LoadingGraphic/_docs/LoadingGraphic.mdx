...
(<LinkTo pageId="illustrations-icon-icon-future-api-specification">Icon</LinkTo>,
<LinkTo pageId="content-avatar">Avatar</LinkTo>,
<LinkTo pageId="illustrations-spot">Spot Illustration</LinkTo>,
Scene Illustration).
