...
You can also use this to target the `--loading-spinner-size` CSS variable if required. Note that this will not affect the stroke width of the svg so use with caution.
