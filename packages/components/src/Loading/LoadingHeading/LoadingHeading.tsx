 ...
 */
export const LoadingHeading = ({ isAnimated, isReversed, width, isLink, classNameOverride, variant, ...props }: LoadingHeadingProps): JSX.Element => (<div className={classnames(styles.loadingHeading, classNameOverride, styles[variant], isAnimated && styles.isAnimated, isReversed && styles.isReversed, isLink && styles.link)} style={{ width: `${width}%` }} {...props}/>);
