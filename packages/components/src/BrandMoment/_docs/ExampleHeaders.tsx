...
export const MinimalBasic = (): JSX.Element => (<div className={styles.header}>
    ...
    <div className={styles.headerRight}>
      <Button href="#" label="Exit" icon={<CloseIcon role="presentation"/>} secondary/>
      <div className={styles.logoContainer}>
        <img src={assetUrl("brand/enso-default.svg")} alt="Culture Amp"/>
      </div>
    </div>
  </div>);
export const MinimalCustomerFocused = (): JSX.Element => (<div className={styles.headerCustomerFocused}>
    <div className={styles.logoContainer}>
      <img src={assetUrl("brand/enso-default.svg")} alt="Culture Amp"/>
    </div>
  </div>);
export const FakeNavBar = (): JSX.Element => (<div className={styles.fakeNav}>
