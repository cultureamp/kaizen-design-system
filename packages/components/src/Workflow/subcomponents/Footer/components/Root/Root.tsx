...
export const FooterRoot = ({ children, classNameOverride, ...restProps }: FooterRootProps): JSX.Element => (<footer className={classnames(styles.footerRoot, classNameOverride)} {...restProps}>
    {children}
  </footer>);
