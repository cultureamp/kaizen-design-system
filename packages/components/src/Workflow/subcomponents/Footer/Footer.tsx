...
import { FooterRoot, FooterAction, ProgressStepper, ProgressStepperProps, } from "./components";
...
export const Footer = ({ steps, stepName, isComplete, previousAction, nextAction, ...restProps }: FooterProps): JSX.Element => (<FooterRoot {...restProps}>
    <FooterAction action={previousAction} actionType="Previous"/>
    <ProgressStepper steps={steps} stepName={stepName} isComplete={isComplete}/>
