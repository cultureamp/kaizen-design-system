...
export const WorkflowControls: Partial<ArgTypes> = {
    headerActions: {
        ...
        mapping: {
            "Single action": [
                <Button key="would-use-uui-1" label="Close" icon={<CloseIcon role="presentation"/>} secondary iconPosition="end"/>,
            ],
            "Multiple actions": [
                <Button key="would-use-uui-1" label="Close" icon={<CloseIcon role="presentation"/>} secondary iconPosition="end"/>,
                <Button key="would-use-uui-2" label="Preview" icon={<VisibleIcon role="presentation"/>} secondary iconPosition="start"/>,
            ],
            "No actions": [],
        },
    },
    nextAction: {
        ...
        mapping: {
            ...
            "Next submit": (<Button reversed formTarget="workflow-form-id" primary label="Finish"/>),
    ...
    previousAction: {
        ...
        mapping: {
            ...
            "Previous submit": (<Button reversed formTarget="workflow-form-id" primary label="Back"/>),
