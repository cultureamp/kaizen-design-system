...
<Canvas layout="fullscreen" of={WorkflowHeader.MultipleActions} />
...
<Canvas layout="fullscreen" of={WorkflowHeader.Playground} />
...
<Canvas layout="fullscreen" of={WorkflowFooter.FirstStep} />

The Footer is agnostic to the JSX elements that are used in the `previousAction` and `nextAction`. We recommend using the `Button` component but an alternative JSX component can be used if you require NextJS Routing.
...
<Canvas layout="fullscreen" of={WorkflowFooter.LastStep} />
...
<Canvas layout="fullscreen" of={WorkflowFooter.AllStepsComplete} />
