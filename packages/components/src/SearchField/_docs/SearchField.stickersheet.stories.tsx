...
const StickerSheetTemplate: StickerSheetStory = {
    render: ({ isReversed }) => {
        ...
        return (<>
        {variants.map(({ heading, variantProps }) => (<React.Fragment key={heading}>
            ...
            <StickerSheet isReversed={isReversed}>
              ...
              <StickerSheet.Body>
                <StickerSheet.Row>
                  ...
                  <SearchField {...variantProps} {...COMMON_PROPS} classNameOverride="story__input-search-hover"/>
                  <SearchField {...variantProps} {...COMMON_PROPS} classNameOverride="story__input-search-focus"/>
                </StickerSheet.Row>
              </StickerSheet.Body>
            </StickerSheet>
          </React.Fragment>))}
