 ...
 */
export const Well = ({ children, variant = "default", borderStyle = "solid", noMargin = false, classNameOverride, ...restProps }: WellProps): JSX.Element => (<div className={classnames(styles.container, styles[borderStyle], styles[variant], noMargin && styles.noMargin, classNameOverride)} {...restProps}>
    {children}
  </div>);
