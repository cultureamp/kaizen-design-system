...
As this component will likely indicate some form of dynamic update on the page it is important to consider how the loading state and content update is communicated to the user, both visually and through assistive technologies.
