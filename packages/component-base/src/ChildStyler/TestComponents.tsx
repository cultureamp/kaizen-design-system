...
interface ExampleChildProps
  extends OverrideClassName<HTMLAttributes<HTMLParagraphElement>>,
    StylerOptions {}

export const ExampleChild: React.VFC<ExampleChildProps> = ({
  classNameOverride,
  margin,
  ...restProps
}) => (
