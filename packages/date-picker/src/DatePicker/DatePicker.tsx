...
export type DatePickerRefs = DateInputRefs & {
 ...
 */
export const DatePicker = React.forwardRef<DatePickerRefs, DatePickerProps>(
  (
    {
      id,
      locale: propsLocale,
    ...
    const fallbackContainerRef = useRef<HTMLInputElement>(null)
