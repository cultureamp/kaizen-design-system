...
// Con: Repeat "label" for button and fields
// Pro: Flexibility if we want different labels for the button vs fields
export const Solution2NoContext: ComponentStory<
  typeof FilterSolution2NoContext
> = () => {
  const buttonRef1 = useRef<HTMLButtonElement>(null)
  const singleButtonRef = useRef<FilterRef>({
    triggerButtonRef: buttonRef1,
...
Solution2NoContext.storyName = "Forced shape button ref; no context"
