...
const preset = {
  theme: {
    ...
    fontSize: {
      ...
      "size-paragraph-lede":
        defaultTheme.typography.paragraphIntroLede.fontSize,
    ...
    lineHeight: {
      ...
      "height-paragraph-lede":
        defaultTheme.typography.paragraphIntroLede.lineHeight,
      "height-paragraph-sm": defaultTheme.typography.paragraphSmall.lineHeight,
      "height-paragraph-xs":
        defaultTheme.typography.paragraphExtraSmall.lineHeight,
      ...
      "height-data-units-md":
        defaultTheme.typography.dataMediumUnits.lineHeight,
