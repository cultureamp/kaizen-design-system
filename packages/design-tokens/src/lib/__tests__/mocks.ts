export const themeForTesting = {
  ...
  color: {
    ...
    'gray-cool': { 100: 'oklch(92.97% 0.0026 228.79)', 200: 'oklch(86.17% 0.0036 219.54)' },
    'gray-warm': { 100: 'oklch(93.23% 0.0128 63.91)', 200: 'oklch(86.21% 0.0095 52.08)' },
  },
} as const

export const heartColorNamePattern =
  /purple|blue|orange|yellow|red|green|gray-cool|gray-warm|cyan|lime|pink/
