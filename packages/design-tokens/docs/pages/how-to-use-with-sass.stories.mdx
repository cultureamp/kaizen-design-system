...
For example `rgba($kz-var-color-stone-rgb-params, 0.5)`, compiles to `rgba(var(--kz-var-color-stone-rgb-params), 0.5)`, which the browser then resolves to `rgba(246, 246, 246, 0.5)` with CSS variables declared.
