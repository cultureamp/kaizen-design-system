...
<CodeBlock
  language="typescript"
  code={`import { ThemeManager, defaultTheme } from '@kaizen/design-tokens'
...
**Note**: it is important to be aware of the loading order of your application's assets. This code needs to be run _before_ any parts of your UI (that depend on CSS variables being defined) are visible. See [Caveats](#caveats)
