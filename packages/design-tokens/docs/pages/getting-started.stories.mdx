...
However, all tokens will automatically work because **every SASS variable that contains a CSS variable will provide a fallback value to the default theme.** See <LinkToStory storyModule={api} />.
...
#### Import a CSS file to apply a theme if you can't instantiate a ThemeManager.
