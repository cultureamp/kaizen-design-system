...
Ensure you have followed the steps in <LinkTo pageId="utilities-kaizenprovider-installation">KaizenProvider</LinkTo> to set up your application for using themes.
