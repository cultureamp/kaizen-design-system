...
export const kaizenTailwindTheme: KaizenTailwindTheme = {
  ...
  fontFamily: {
    "family-paragraph": ["var(--typography-paragraph-small-font-family)"],
    "family-heading": ["var(--typography-heading-1-font-family)"],
    "family-data": [`${tokens.typography.dataLarge.fontFamily}`],
    "family-display": ["var(--typography-display-0-font-family)"],
  },
  fontSize: {
    display: `${tokens.typography.display0.fontSize}`,
    "heading-1": "var(--typography-heading-1-font-size)",
    "heading-2": "var(--typography-heading-2-font-size)",
    "heading-3": "var(--typography-heading-3-font-size)",
    "heading-4": "var(--typography-heading-4-font-size)",
    "heading-5": "var(--typography-heading-5-font-size)",
    "heading-6": "var(--typography-heading-6-font-size)",
    paragraph: "var(--typography-paragraph-body-font-size)",
    "paragraph-lede": `${tokens.typography.paragraphIntroLede.fontSize}`,
    "paragraph-sm": "var(--typography-paragraph-small-font-size)",
    "paragraph-xs": "var(--typography-paragraph-extra-small-font-size)",
