...
export const items: ItemType[] = [
  ...
  { label: "Back-End", value: "id-be", count: "4", disabled: true },
  { label: "SRE", value: "id-sre", count: "4", disabled: true },
  ...
  { label: "Engineer-type-4", value: "id-type-4", count: "4", disabled: true },
