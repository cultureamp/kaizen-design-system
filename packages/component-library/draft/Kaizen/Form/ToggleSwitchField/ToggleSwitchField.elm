module Kaizen.Form.ToggleSwitchField.ToggleSwitchField exposing (..)
...
view (Config config) =
    let
        ...
        inlineProp =
            convertToBool config.inline

        disabledProp =
            convertToBool config.disabled

        fullWidthProp =
            convertToBool config.fullWidth
