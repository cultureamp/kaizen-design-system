...
*   When there's only 2-3 options and enough space, use a [checkbox group](/components/checkbox-group), [radio group](/components/radio), or [toggle switch](/components/toggle-switch) instead.
