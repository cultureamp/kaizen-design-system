...
```
.myButton {
  composes: interactiveIconWrapper from '@kaizen/component-library/styles/components/Icon.module.scss';
}

.myReversedButton {
  composes: reversedInteractiveIconWrapper from '@kaizen/component-library/styles/components/Icon.module.scss';
}
```
