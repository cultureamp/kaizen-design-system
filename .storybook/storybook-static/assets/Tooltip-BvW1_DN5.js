...
`,e.jsx(i,{of:f}),`
`,e.jsxs(o.p,{children:["In these instances, ",e.jsx(o.code,{children:"aria-describedby"})," can be leveraged to provide a description to the input."]})]})}function je(t={}){const{wrapper:o}={...r(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(s,{...t})}):s(t)}export{je as default};
