import{R as e,r as $}from"./index-CTjT7uj6.js";import{A as ee}from"./AddIcon-C6V_KfCs.js";import{A as re}from"./ArrowRightIcon-CtsqbiFB.js";import{T as te}from"./TextField-C70Pg5K2.js";import{B as t}from"./Button-DDkdQqLR.js";import{L as ae}from"./LoadingInput-X-emq8Sb.js";const ne={title:"Actions/Button/v1",component:t,args:{label:"Label"}},n={parameters:{docs:{canvas:{sourceState:"shown"}}}},a={render:({reversed:r})=>e.createElement(e.Fragment,null,e.createElement(t,{label:"Default",reversed:r}),e.createElement(t,{label:"Primary",primary:!0,reversed:r}),e.createElement(t,{label:"Destructive",destructive:!0,reversed:r}),e.createElement(t,{label:"Secondary",secondary:!0,reversed:r}),!r&&e.createElement(t,{label:"Secondary Destructive",secondary:!0,destructive:!0})),decorators:[r=>e.createElement("div",{style:{display:"flex",gap:"1rem"}},e.createElement(r,null))],parameters:{controls:{disable:!0}}},o={...a,args:{reversed:!0},parameters:{...a.parameters,backgrounds:{default:"Purple 700"}}},s={args:{disabled:!0}},oe=`
...
}`,...(S=(y=n.parameters)==null?void 0:y.docs)==null?void 0:S.source}}};var k,v,E;a.parameters={...a.parameters,docs:{...(k=a.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: ({
    reversed
  }) => <>
...
}`,...(E=(v=a.parameters)==null?void 0:v.docs)==null?void 0:E.source}}};var w,B,L;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Variants,
  args: {
    reversed: true
  },
...
}`,...(h=(R=s.parameters)==null?void 0:R.docs)==null?void 0:h.source}}};var I,W,A;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(A=(W=c.parameters)==null?void 0:W.docs)==null?void 0:A.source}}};var P,T,C;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    icon: <ArrowRightIcon role="presentation" />,
    iconPosition: "end"
  }
}`,...(C=(T=l.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var F,D,V;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    badge: {
      text: "3",
      variant: "active"
