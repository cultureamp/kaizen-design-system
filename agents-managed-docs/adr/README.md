...
| [0006](0006-no-animation-or-interaction-before-data-ready.md) | No Animation or Interaction Before Dependent Data Is Ready       | Data-dependent regions stay static and non-interactive until their data is ready; pre-hydration counts as not-ready. **Proposed.**                                  |
