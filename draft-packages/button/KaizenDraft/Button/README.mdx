...
*   All buttons excluding [Pagination](https://cultureamp.design/components/pagination/) use a button element (not a link element and no `role=”button”`)
...
*   **Pagination buttons:**
    * These are purpose-built for the [Pagination](https://cultureamp.design/components/pagination/) component.
    ...
    * **Directional link:**
        ...
        * “Back” and “Next” links allow page navigation to occur incrementally across a page list. 
        * (Optional) “Start” and “End” links allow the user to skip to the first and last items in a page list.
*   **Focus indicator:**
...
*   If the button is used to toggle between 2 states, consider using a [Toggle Switch](/components/toggle-switch-field) instead.
