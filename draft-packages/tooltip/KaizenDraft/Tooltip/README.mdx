...
*   When combined with an icon, use the matching icon and mood (Positive, Informative, Cautionary). For example, when using a Cluny (blue) colored information icon, show an informative tooltip.
