...
var MenuGroup = function (_a) {
    var title = _a.title, items = _a.items, _b = _a.first, first = _b === void 0 ? false : _b, offCanvas = _a.offCanvas;
    var renderOffCanvasMenuItem = function (item) { return (react_1["default"].createElement(Link_1["default"], { key: item.url, text: item.label, href: item.url })); };
    ...
    var renderMenuGroup = function () { return (react_1["default"].createElement("li", { className: styles.container },
        react_1["default"].createElement("h4", { className: styles.title }, title),
        react_1["default"].createElement("ul", { className: styles.subList }, items.map(function (item) { return (react_1["default"].createElement(MenuItem_1["default"], __assign({ key: item.url + "-" + v4_1["default"]() }, item))); })))); };
