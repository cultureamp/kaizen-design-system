...
Your CTA button should compliment the title of the modal. If a user scans the title, the CTA button should clearly direct them towards an action. Don’t hesitate to use “next” as a button if the modal includes multiple pages.
