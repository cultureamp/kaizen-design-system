...
## Options
  ...
  - Confirmation:
      ...
      - Negative
  - Input-edit
  - Context (previously Information)
...
- **Prominent** includes an animated spot illustration to help convey increased sentiment to the user. Use the Prominent modal when you want to celebrate the completion of a task or make it known that you need the user to pay attention to important information.
...
- Content: Additional context about the confirmation
