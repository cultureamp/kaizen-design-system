...
deprecated: true
deprecationDate: TBA
deprecationMessage: No further changes will be made to this component as it will be superseded by `Tile`.
title: Hero Card (draft-hero-card)
navTitle: Hero Card (draft-hero-card)
