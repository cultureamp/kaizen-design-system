...
* When you have enough content to fill the space effectively. If you only have a little bit of information, use a [Guidance Block](/components/guidance-block) or a [Container](/components/container) component.
...
*   When there's long form content underneath, such as high density data in a [Table](/components/table), consider using a less prominent component, such as a [Guidance Block](/components/guidance-block) or a [Container](/components/container) component.
