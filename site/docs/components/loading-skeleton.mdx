...
* In practice, a loading skeleton is a preset configuration of [loading placeholders](./loading-placeholder).
...
* If a **page refresh is required**, use an [Empty State](./empty-state) with a Call To Action to refresh.
