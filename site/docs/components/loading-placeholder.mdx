...
deprecated: true
deprecationDate: TBA
deprecationMessage: Use `@kaizen/loading-skeleton` instead.
title: Loading Placeholder (draft-loading-placeholder)
navTitle: Loading Placeholder (draft-loading-placeholder)
...
needToKnow:
- ⛔️ LoadingPlaceholder is deprecated. Use the `@kaizen/loading-skeleton` package instead.
demoStoryId: deprecated-loading-placeholder--default-multiple-kaizen-site-demo
health:
  designed: true
  documented: true
  implemented: true
