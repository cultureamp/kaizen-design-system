...
- **Default:**
    - In a default slider, the user can make an imprecise selection from a range of values, where there is no implication of progression from one side to the other.
- **Progress:**
    - In a progress slider, the user can make an precise selection from a range of values, aided by an exact indication of value. A sense of progress is implied, from one side to the other.
...
- Default sliders have no fill. The progress slider uses a fill to give the impression of building towards the maximum value.
