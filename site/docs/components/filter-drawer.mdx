...
Use the filter drawer to house [Select](/components/select) and [Date Picker](/components/date-picker) components. Do not include [Search Fields](/components/search-field), which always live outside of the filter drawer.
