...
**To prevent errors**, you might disable dates before or after dates that don't make sense. For example, an employee cannot start at a company before they are born, so for selecting a start date, you might disable dates before their date of birth. To do this, you might set a "min" date or a "max" date. See the [Interaction states guidelines](/guidelines/interaction-states#disabled).
