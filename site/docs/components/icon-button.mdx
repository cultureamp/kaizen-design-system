...
Disabled Icon Buttons use 30% opacity on the component itself (not, for example, the inner icon) as described in the [Interaction states guidelines](/guidelines/interaction-states).
