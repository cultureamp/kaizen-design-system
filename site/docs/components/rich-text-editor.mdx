...
needToKnow: 
- Used to create & publish content for other users, where:
  - Control over the look & feel of that content is important (e.g. survey communications)
  - Users require the ability to structure text to make it more readable (e.g. performance reviews & manager 1:1s)
---
