...
- **Display 0:** Use for brand moments including, introductory screens (Onboarding, Success pages etc.) or landing pages (Log In and Capture Intro etc.).

- **Heading 1:** H1 is used for page Titles in the [Title Block](/guidelines/header/#title-block) of the page [Header](/guidelines/header/)

- **Heading 2:** H2 is used for headings that introduce a major section of content. Generally outside of a card. Generally at the top of a content area, below the Title Block.

- **Heading 3:** H3 is used within a card as a heading

- **Heading 4:** H4 is used to define the name/title of a survey, report or other primary information within a card.

- **Heading 5:** H5 is used in long form content when you have 5 heading levels. Consider breaking this level of detail into its own page with larger headings.

- **Heading 6:** H6 is used for table headers, or small headings above content, such as form inputs or defining categories of content.


### Paragraphs

- **Intro Lede:** Use for the introductory text on introductory screens (Onboarding, Log In, Success pages etc.) or landing pages, paired with Display 0.

- **Body:** Use paragraph text for nearly all body copy.
...
- **Preformatted:** Use for code snippets or spreadsheet data.

### Data

- **123 Large:** Use for Large Hero Data that's the primary information of a section.

- **$% Large:** Use for percent, dollar, "+", "-" "x" when paired with large hero data numbers.

- **123 Medium:** Use for Medium Data in lists.

- **$% Medium:** Use for percent, dollar, "+", "-" "x" when paired with medium data in lists.

- **123 Small:** Use for small, standalone data in lists. There is no separate small style for percent, dollar, "+", "-", or "x" because it needs to remain legible.
