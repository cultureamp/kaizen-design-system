...
tags: ["Data Tables", "Tabular Data", "Tiles", "Rows", "Grids"]
inComparingSection: true
---

- **Tables also known as:** Data Tables, Tabular Data
- **Lists also known as:** Tiles
...
#### Structure
- Tables must represent more than 1 row of tabular data, otherwise use a tile to contain a small volume of data. (e.g. [Tile](/components/tile) / List)
...
- Lists can be either stacked horizontal rows or grids of [Tiles](/components/tile)
