...
- Lists are sortable by a ‘Sorted by’ Select, and do not have header labels.
- A single row of a list could make sense
...
### For the user
- They help make it easy to scan large amounts of data.
- Makes it efficient to find patterns in values.
