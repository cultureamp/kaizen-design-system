...
needToKnow:
  - Use official color palette colors, variables and helpers (add-tint, add-shade, add-alpha) for all color CSS declarations. Never hard-code a color without a variable.
  - Use tints and shades (to add white or black) in 10% steps.
