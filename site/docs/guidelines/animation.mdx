...
needToKnow:
  ...
  - "Test 100 animated instances shown at once. Test an animation repeated 100 times."
  - "Aim for a fast time to first interaction of 300ms or less with primary content or data."
  - "Use 1 primary call to action."
...
```
.animation {
  animation: pulsate 0.3s $ca-ease-in-out infinite both;
}
