...
- Alternative text:
  - In components such as [validation tags](../components/tags), we need to provide non-visual alternative text to convey the mood.
  - In components such as [notifications](./notifications), we expect the content of the notification itself to convey important information, such as drawing attention to an error when using the negative mood.
