...
title: Moods
navTitle: Moods
summaryParagraph: Our set of Positive, Informative, Cautionary, Assertive, Negative and Prominent moods create an emotional impact and help to contextualize information.
...
- Illustration:
  - For [empty states](/components/empty-state), we use animated illustrations with a background color that matches the mood.
- Alternative text:
