...
Neutral 100 (White) is used for text and icons on dark backgrounds. Neutral 200 is the product’s canvas. Neutral 300 → Neutral 600 are primarily used for borders.
