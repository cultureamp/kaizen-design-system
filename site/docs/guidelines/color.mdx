...
White 100 is used for text and icons on dark backgrounds. Stone 200 is the product’s canvas. Ash 300 → Slate 700 are primarily used for borders.
...
For the most important action on a page, use Blue 500 (or Green 400 on our Default Header: Purple 600 background.

### Data visualization

See [data visualization](/guidelines/data-visualization) for details.

- For favorable scores and general positive colored graphs / visualizations, use Data Viz / Favorable
- For unfavorable scores and general negative colored graphs / visualizations, use Data Viz / Unfavorable
...
- Colors can help to create visual patterns that the user can recall (for example, links are always Blue 500 colored or negative favorability scores, errors, and destructive actions are always Coral).
