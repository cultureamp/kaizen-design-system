...
import ZenPurple from "docs-components/color/ZenPurple"
import ZenGrays from "docs-components/color/ZenGrays"
import ZenWhite from "docs-components/color/ZenWhite"
import ZenBlue from "docs-components/color/ZenBlue"
import ZenGreen from "docs-components/color/ZenGreen"
import ZenYellow from "docs-components/color/ZenYellow"
import ZenOrange from "docs-components/color/ZenOrange"
import ZenRed from "docs-components/color/ZenRed"
...
To learn more, Culture Amp employees can visit the [Color page in Figma](https://www.figma.com/file/eZKEE5kXbEMY3lx84oz8iN/%E2%9D%A4%EF%B8%8F-UI-Kit%3A-Heart?node-id=1929%3A81).
