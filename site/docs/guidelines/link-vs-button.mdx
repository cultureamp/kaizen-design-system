...
needToKnow:
  ...
  - "Link content opens in a new tab only when absolutely necessary. A new tab can be disorienting. If we need to open something in a new tab, we must use an "Opens in a new tab" tooltip to set expectations and minimise disorientation."
---
