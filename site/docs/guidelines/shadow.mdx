...
- Our Ink brand color is **not** used as the base color for a shadow. Ink is made up of a range of colors. When it is mixed with a primary or secondary color, it will create a muddied effect.
