...
### Focus indicator
- Any element a user can interact with must have a focus indicator when tabbing while using keyboard navigation. This helps users with assistive technology understand what they are interacting with and where they are on the page. 
