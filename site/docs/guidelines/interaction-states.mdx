...
summaryParagraph: Interaction states are visual representations use to communicate the state of an interactive element.
...
needToKnow:
  ...
  - "There are other visual variations beyond interaction states that are not covered here, such as primary, secondary, destructive, reversed, persistent/dismissible styles, visited/unvisited, and expand/collapse."
---
...
- Disable elements when they are temporarily unavailable and removing it would be conspicuous.
...
- Consider providing a message to explain why an element is disabled.
...
- [Checkbox Group](/component/checkbox-group).
