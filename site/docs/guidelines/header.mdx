...
- Variants:
    ...
    - **Account admin (Neutral-100):** This is for the Account admin section of the platform, accessed through the 'Account admin' label in the utility navigation. This header does not include a skirt. Note that flow-of-work admin pages (those accessed through the main navigation) do not use the Account admin header.
